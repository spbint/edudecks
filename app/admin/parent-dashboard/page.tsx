...
export default function FamilyDashboardScreen({
  ...
  const selectedFramework = useMemo(
    () => frameworks.find((f) => f.id === selectedFrameworkId) || frameworks[0] || null,
  ...
  const pageBg = isPublic
    ? "linear-gradient(180deg, #f8fafc 0%, #eff6ff 100%)"
    : "#f8fafc";

  const heroTitle = isPublic ? "Your Family Learning Home" : "Family Learning Home";

  const shellMaxWidth = isPublic ? 1320 : 1400;
  ...
  return (
    ...
    >
      {isPublic ? (
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: "#64748b" }}>
                  Record learning. See coverage. Build reporting confidence.
                </div>
              </div>
            </div>
            ...
            >
              <Link href="/family" style={buttonStyle(false, "sm")}>
                Home
              </Link>
              <Link href="/portfolio" style={buttonStyle(false, "sm")}>
                Portfolio
              </Link>
              <Link href="/reports" style={buttonStyle(false, "sm")}>
                Reports
              </Link>
              <button
                style={buttonStyle(true, "sm")}
      ...
      <main
        style={{
          padding: isPublic ? "28px 24px 40px" : 24,
        }}
      >
        <div style={{ maxWidth: shellMaxWidth, margin: "0 auto" }}>
          ...
          >
            <div>
              ...
              >
                {isPublic ? "Family Dashboard" : "Family Dashboard"}
              </div>
              <div
                style={{
                  fontSize: 28,
