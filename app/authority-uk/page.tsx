...
export default function AuthorityUkPage() {
  ...
  const bestNextMove =
    readiness === "Strong"
      ? {
          title: "Move into UK pack-building or final output",
          text: "The current record appears broad enough to support a calmer UK-facing pathway.",
      ...
      : readiness === "Building"
        ? {
            ...
            text: `The current record is promising, though more depth in ${weakestArea} would make the UK pathway stronger.`,
            href: "/capture",
            cta: "Capture More Evidence",
          }
        : {
            title: "Grow the learning record first",
            text: "The strongest UK-ready pathways begin with a wider body of evidence gathered over time.",
            href: "/capture",
  ...
  return (
    <FamilyTopNavShell
      ...
      heroTitle="United Kingdom authority pathway"
      heroText="This page helps families shape a UK-focused pathway from evidence to reports and authority pack building. The goal is calm visibility, not pressure."
      heroAsideTitle="UK pathway signal"
      heroAsideText={
        readiness === "Strong"
          ? "The current record looks broad enough to support a United Kingdom-focused compliance pathway."
          : readiness === "Building"
            ? "The record is heading in a useful direction, though more breadth would strengthen the UK-ready picture."
            : "The UK pathway is available, but the evidence base is still early."
      }
    >
      <section
        style={{
      ...
      >
        <div>
          <div style={{ fontSize: 12, fontWeight: 800, color: "#64748b" }}>
            United Kingdom Authority Hub
          </div>
          <div style={{ fontSize: 28, fontWeight: 900, color: "#0f172a" }}>
            {activeChild ? `UK pathway for ${childDisplayName(activeChild)}` : "UK pathway"}
          </div>
        </div>
      ...
      {busy ? (
        <div style={{ ...cardStyle(), marginBottom: 18 }}>Loading United Kingdom authority view…</div>
      ) : err ? (
        <div
          style={{
            ...cardStyle(),
        ...
        <div style={{ ...cardStyle(), marginBottom: 18 }}>
          ...
          <div style={{ color: "#475569", lineHeight: 1.6, marginBottom: 14 }}>
            Add a child first so EduDecks can shape a UK authority pathway around a real learner and a real record.
          </div>
        ...
        <>
          ...
          >
            <div style={cardStyle()}>
              <div style={{ fontSize: 22, fontWeight: 900, marginBottom: 10 }}>United Kingdom pathway view</div>
              ...
              <div style={{ display: "grid", gap: 12 }}>
                ...
                >
                  ...
                  <div style={{ fontSize: 14, lineHeight: 1.6, color: "#334155" }}>
                    {readiness === "Strong"
                      ? "The current learning record has enough breadth to support a more formal United Kingdom-facing pathway."
                      : readiness === "Building"
                        ? "The current record is moving in a useful direction, though it would benefit from a little more spread before final export."
                        : "The UK pathway is still early. Build more breadth through capture and portfolio first."}
                  </div>
                </div>
            ...
            <div style={{ display: "grid", gap: 18 }}>
              ...
              <section style={cardStyle()}>
                ...
                >
                  A stronger UK-ready record usually means
                </div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  The strongest UK pathway is capture → portfolio → report → pack
                </div>
                ...
                >
                  The United Kingdom authority view is strongest when it stays connected to the living family record rather than feeling like a separate process at the end.
                </div>
              </div>
