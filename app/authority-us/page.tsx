...
export default function AuthorityUsPage() {
  ...
  const bestNextMove =
    readiness === "Strong"
      ? {
          title: "Move into US pack-building or final output",
          text: "The current record appears broad enough to support a calmer United States-facing pathway.",
      ...
      : readiness === "Building"
        ? {
            ...
            text: `The current record is promising, though more depth in ${weakestArea} would make the US pathway stronger.`,
            href: "/capture",
            cta: "Capture More Evidence",
          }
        : {
            title: "Grow the learning record first",
            text: "The strongest US-ready pathways begin with a wider body of evidence gathered over time.",
            href: "/capture",
  ...
  return (
    <FamilyTopNavShell
      ...
      heroTitle="United States authority pathway"
      heroText="This page helps families shape a US-focused pathway from evidence to reports and authority pack building. The goal is calm visibility, not pressure."
      heroAsideTitle="US pathway signal"
      heroAsideText={
        readiness === "Strong"
          ? "The current record looks broad enough to support a United States-focused compliance pathway."
          : readiness === "Building"
            ? "The record is heading in a useful direction, though more breadth would strengthen the US-ready picture."
            : "The US pathway is available, but the evidence base is still early."
      }
    >
      <section
        style={{
      ...
      >
        <div>
          <div style={{ fontSize: 12, fontWeight: 800, color: "#64748b" }}>
            United States Authority Hub
          </div>
          <div style={{ fontSize: 28, fontWeight: 900, color: "#0f172a" }}>
            {activeChild ? `US pathway for ${childDisplayName(activeChild)}` : "US pathway"}
          </div>
        </div>
      ...
      {busy ? (
        <div style={{ ...cardStyle(), marginBottom: 18 }}>Loading United States authority view…</div>
      ) : err ? (
        <div
          style={{
            ...cardStyle(),
        ...
        <>
          ...
          >
            <div style={cardStyle()}>
              <div style={{ fontSize: 22, fontWeight: 900, marginBottom: 10 }}>United States pathway view</div>
              ...
              <div style={{ display: "grid", gap: 12 }}>
                ...
                >
                  ...
                  <div style={{ fontSize: 14, lineHeight: 1.6, color: "#334155" }}>
                    {readiness === "Strong"
                      ? "The current learning record has enough breadth to support a more formal United States-facing pathway."
                      : readiness === "Building"
                        ? "The current record is moving in a useful direction, though it would benefit from a little more spread before final export."
                        : "The US pathway is still early. Build more breadth through capture and portfolio first."}
                  </div>
                </div>
            ...
            <div style={{ display: "grid", gap: 18 }}>
              ...
              <section style={cardStyle()}>
                ...
                >
                  A stronger US-ready record usually means
                </div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  The strongest US pathway is capture → portfolio → report → pack
                </div>
                ...
                >
                  The United States authority view is strongest when it stays connected to the living family record rather than feeling like a separate process at the end.
                </div>
              </div>
