...
function renderEarlyNumberVisual(item: NumberAssessmentBankItem) {
  ...
  if (isOperationsStep2ShareCompareActivity(item.id, item.progressionStepKey)) {
    const operationsStep2Visual =
      parseEarlyNumberVisualDescription(item.visualSupport?.description) ?? visual;
    return renderOperationsStep2WorksheetPromptVisual({
      prompt: item.prompt,
      visual: operationsStep2Visual,
    });
  }
  ...
  if (isOperationsStep5EqualGroupsActivity(item.id, item.progressionStepKey)) {
  ...
  if (isStep51StandardFormActivity(item.id, item.progressionStepKey)) {
    const step51Visual =
      parseEarlyNumberVisualDescription(item.visualSupport?.description) ?? visual;
  ...
  if (isStep53ExactFractionsPiActivity(item.id, item.progressionStepKey)) {
    const step53Visual =
      parseEarlyNumberVisualDescription(item.visualSupport?.description) ?? visual;
  ...
  if (isStep54PercentageChangeActivity(item.id, item.progressionStepKey)) {
    const step54Visual =
      parseEarlyNumberVisualDescription(item.visualSupport?.description) ?? visual;
  ...
  if (isStep55RatioProportionRatesActivity(item.id, item.progressionStepKey)) {
    const step55Visual =
      parseEarlyNumberVisualDescription(item.visualSupport?.description) ?? visual;
  ...
  if (isStep56AlgebraGraphActivity(item.id, item.progressionStepKey)) {
    const step56Visual =
      parseEarlyNumberVisualDescription(item.visualSupport?.description) ?? visual;
  ...
  if (isStep57FinancialModellingActivity(item.id, item.progressionStepKey)) {
    const step57Visual =
      parseEarlyNumberVisualDescription(item.visualSupport?.description) ?? visual;
  ...
  if (isStep59EfficientStrategyActivity(item.id, item.progressionStepKey)) {
    const step59Visual =
      parseEarlyNumberVisualDescription(item.visualSupport?.description) ?? visual;
...
function CleanNumberAssessmentPlayerBody() {
  ...
  function renderResponseControl() {
    ...
    if (currentItem.answerType === "multiple_choice") {
      ...
      const operationsStep2ShareCompareOptions = isOperationsStep2ShareCompareActivity(
        currentItem.id,
        currentItem.progressionStepKey,
      );
      ...
      const operationsStep5EqualGroupsOptions = isOperationsStep5EqualGroupsActivity(
        currentItem.id,
        currentItem.progressionStepKey,
      );
      ...
      const step51StandardFormOptions = isStep51StandardFormActivity(
        currentItem.id,
        currentItem.progressionStepKey,
      );
      const step53ExactFractionsPiOptions = isStep53ExactFractionsPiActivity(
        currentItem.id,
        currentItem.progressionStepKey,
      );
      const step54PercentageChangeOptions = isStep54PercentageChangeActivity(
        currentItem.id,
        currentItem.progressionStepKey,
      );
      const step55RatioProportionRatesOptions = isStep55RatioProportionRatesActivity(
        currentItem.id,
        currentItem.progressionStepKey,
      );
      const step56AlgebraGraphOptions = isStep56AlgebraGraphActivity(
        currentItem.id,
        currentItem.progressionStepKey,
      );
      const step57FinancialModellingOptions = isStep57FinancialModellingActivity(
        currentItem.id,
        currentItem.progressionStepKey,
      );
      ...
      const step59EfficientStrategyOptions = isStep59EfficientStrategyActivity(
        currentItem.id,
        currentItem.progressionStepKey,
      );
          ...
          {(currentItem.options ?? []).map((option) => {
            ...
            const statisticsVisual =
              ...
              (currentItem.id.startsWith("statistics-data-step-1-") ||
                ...
                currentItem.id.startsWith("statistics-data-step-3-") ||
                currentItem.id.startsWith("statistics-data-step-4-") ||
            ...
            const operationsStep2Visual =
              ...
              !step7Visual &&
              !step8Visual &&
              operationsStep2ShareCompareOptions
                ? renderOperationsStep2WorksheetOptionCard({
                    option,
                    selected: isSelected,
                  })
