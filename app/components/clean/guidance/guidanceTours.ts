...
export const GUIDANCE_TOURS: Record<GuidanceTourId, GuidanceTourDefinition> = {
  "my-profile": {
    ...
    steps: [
      ...
      {
        guidanceId: "profile-learner-first-name",
        title: "Add a learner first name",
        body: "Enter the learner's first name so plans and evidence can be connected to the right person.",
      },
      {
        guidanceId: "profile-add-learner-button",
        title: "Add learner",
        body: "Use this button after the learner first name is entered. You can add preferred name or year level only if it helps.",
      },
      {
        guidanceId: "profile-learner-details",
        title: "Review learner details",
        body: "Check the learner list and choose a default learner if that will make planning quicker.",
      },
      {
        guidanceId: "profile-next-settings",
        title: "Save profile and continue",
        body: "After your profile is ready, continue to My Settings to choose country, curriculum and reporting context.",
      },
    ],
  },
  "my-settings": {
    ...
    steps: [
      {
        ...
        body: "This is where you set your learning year and first term. MyLearna uses this structure to organise planning and records.",
      },
      {
        guidanceId: "calendar-learning-year",
        title: "Save the learning year",
        body: "Start with the bigger date range MyLearna should plan inside. This can be adjusted later.",
      },
      {
        guidanceId: "calendar-first-term",
        title: "Add the first learning term",
        body: "After the year is saved, add the first term or learning period so weekly planning has a clear home.",
      },
      {
        guidanceId: "calendar-next-day",
        title: "Next step: check My Day",
        body: "Once the learning year and first term are started, open My Day to see today's learning view.",
      },
    ],
  },
  "my-day": {
