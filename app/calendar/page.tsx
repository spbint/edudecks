...
const styles: Record<string, React.CSSProperties> = {
  ...
  heroMetaRow: { marginTop: 16, display: "flex", flexWrap: "wrap", gap: 12 },
  metaPill: { display: "flex", alignItems: "center", gap: 8, borderRadius: 999, border: "1px solid #e2e8f0", background: "#f8fafc", padding: "10px 14px", maxWidth: "100%" },
  metaLabel: { fontSize: 13, fontWeight: 700, color: "#64748b" },
  metaValue: { fontSize: 14, fontWeight: 700, color: "#0f172a" },
  heroHelperText: { marginTop: 12, fontSize: 13, fontWeight: 600, color: "#64748b", lineHeight: 1.6 },
  bridgeCard: { background: "#fff", border: "1px solid rgba(15,23,42,0.08)", borderRadius: 24, padding: 20, boxShadow: "0 12px 36px rgba(15,23,42,0.05)", marginBottom: 18 },
  bridgeTop: { display: "flex", justifyContent: "space-between", gap: 16, alignItems: "flex-start", flexWrap: "wrap", marginBottom: 14 },
  bridgeEyebrow: { fontSize: 12, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.1em", color: "#64748b", marginBottom: 8 },
  bridgeTitle: { fontSize: 22, fontWeight: 800, color: "#0f172a" },
  bridgeText: { marginTop: 8, color: "#475569", lineHeight: 1.6, fontSize: 14, maxWidth: 760 },
  bridgeTopActions: { display: "flex", gap: 10, flexWrap: "wrap" },
  bridgePrimaryButton: { appearance: "none", border: "none", background: "#0f172a", color: "#fff", borderRadius: 14, padding: "12px 16px", fontWeight: 800, fontSize: 13, cursor: "pointer" },
  bridgeSecondaryLink: { display: "inline-flex", alignItems: "center", justifyContent: "center", border: "1px solid #cbd5e1", background: "#fff", color: "#0f172a", borderRadius: 14, padding: "12px 16px", fontWeight: 800, fontSize: 13, textDecoration: "none" },
  bridgeEncouragement: { marginBottom: 14, background: "#f8fbff", border: "1px solid #e2ecf7", borderRadius: 18, padding: 14, color: "#334155", lineHeight: 1.6, fontSize: 14, fontWeight: 600 },
  bridgeGrid: { display: "grid", gap: 12 },
  bridgeActionCard: { border: "1px solid #e2e8f0", borderRadius: 18, background: "#f8fafc", padding: 14 },
  bridgeActionTitle: { fontSize: 16, fontWeight: 800, color: "#0f172a" },
  bridgeActionText: { marginTop: 6, color: "#64748b", lineHeight: 1.55, fontSize: 14 },
  bridgeActionButtons: { marginTop: 12, display: "grid", gap: 10 },
  bridgeSmallButton: { appearance: "none", border: "1px solid #0f172a", background: "#0f172a", color: "#fff", borderRadius: 12, padding: "10px 12px", fontSize: 12, fontWeight: 800, cursor: "pointer", justifySelf: "start" },
  bridgeDayButtons: { display: "flex", flexWrap: "wrap", gap: 8 },
  bridgeDayButton: { appearance: "none", border: "1px solid #cbd5e1", background: "#fff", color: "#334155", borderRadius: 10, padding: "8px 10px", fontSize: 12, fontWeight: 700, cursor: "pointer" },
  bridgeEmpty: { color: "#64748b", lineHeight: 1.6, fontSize: 14 },
  bridgeMessage: { marginTop: 12, minHeight: 20, color: "#1d4ed8", fontSize: 14, fontWeight: 700 },
  toolbarCard: { background: "#fff", border: "1px solid rgba(15,23,42,0.08)", borderRadius: 24, padding: 20, boxShadow: "0 12px 36px rgba(15,23,42,0.05)", marginBottom: 18 },
  toolbarTop: { display: "flex", justifyContent: "space-between", gap: 14, alignItems: "center", flexWrap: "wrap", marginBottom: 14 },
  navCluster: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" },
  lightButton: { appearance: "none", border: "1px solid #dbe3ee", background: "#fff", color: "#0f172a", borderRadius: 12, padding: "10px 14px", fontSize: 14, fontWeight: 800, cursor: "pointer" },
  iconButton: { appearance: "none", border: "1px solid #dbe3ee", background: "#fff", color: "#0f172a", borderRadius: 12, width: 42, height: 42, fontSize: 18, fontWeight: 800, cursor: "pointer" },
  dateTitle: { fontSize: 24, fontWeight: 800, color: "#0f172a" },
  rightToolbar: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" },
  viewToggle: { display: "flex", gap: 6, background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 14, padding: 4 },
  toggleButton: { appearance: "none", border: "none", background: "transparent", color: "#475569", borderRadius: 10, padding: "10px 14px", fontWeight: 800, cursor: "pointer", fontSize: 13 },
  toggleButtonActive: { background: "#0f172a", color: "#fff" },
  addBar: { display: "grid", gridTemplateColumns: "minmax(0, 1.4fr) auto auto auto auto", gap: 10, alignItems: "center" },
  input: { width: "100%", minHeight: 48, borderRadius: 14, border: "1px solid #dbe3ee", padding: "12px 14px", fontSize: 15, outline: "none", background: "#fff", color: "#0f172a" },
  quickTextarea: { width: "100%", marginTop: 10, borderRadius: 16, border: "1px solid #dbe3ee", padding: "12px 14px", fontSize: 14, lineHeight: 1.6, resize: "vertical", outline: "none", background: "#fff", color: "#334155" },
  select: { minHeight: 48, borderRadius: 14, border: "1px solid #dbe3ee", padding: "12px 14px", fontSize: 14, outline: "none", background: "#fff", color: "#0f172a" },
  timeInput: { minHeight: 48, width: 140, borderRadius: 14, border: "1px solid #dbe3ee", padding: "12px 14px", fontSize: 14, outline: "none", background: "#fff", color: "#0f172a" },
  dateInput: { minHeight: 48, borderRadius: 14, border: "1px solid #dbe3ee", padding: "12px 14px", fontSize: 14, outline: "none", background: "#fff", color: "#0f172a" },
  addButton: { appearance: "none", border: "none", background: "#0f172a", color: "#fff", borderRadius: 14, padding: "12px 16px", fontWeight: 800, cursor: "pointer", minHeight: 48 },
  weekSection: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0, 1fr))", gap: 14, alignItems: "start", marginBottom: 20 },
  weekColumn: { background: "#ffffff", border: "1px solid rgba(15,23,42,0.08)", borderRadius: 24, padding: 14, boxShadow: "0 12px 30px rgba(15,23,42,0.04)", minHeight: 680, display: "flex", flexDirection: "column", gap: 12 },
  todayColumn: { boxShadow: "0 0 0 2px rgba(59,130,246,0.2), 0 12px 30px rgba(15,23,42,0.06)", background: "#fbfdff" },
  weekHeader: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 },
  weekDayName: { fontSize: 18, fontWeight: 800, color: "#0f172a" },
  dayLoadText: { fontSize: 12, fontWeight: 700, color: "#64748b", marginTop: 4 },
  todayBadge: { display: "inline-flex", alignItems: "center", justifyContent: "center", borderRadius: 999, background: "#dbeafe", color: "#1d4ed8", padding: "6px 10px", fontSize: 12, fontWeight: 800 },
  dayNote: { width: "100%", borderRadius: 18, border: "1px solid #f5e48d", background: "#fffad1", padding: "12px 14px", resize: "vertical", outline: "none", minHeight: 110, lineHeight: 1.55, color: "#334155", fontSize: 14 },
  columnItems: { display: "grid", gap: 10, alignContent: "start" },
  weekEmptyState: { border: "1px dashed #cbd5e1", background: "#f8fafc", borderRadius: 18, padding: 14 },
  weekEmptyTitle: { fontSize: 15, fontWeight: 800, color: "#0f172a", marginBottom: 6 },
  weekEmptyText: { fontSize: 13, lineHeight: 1.5, color: "#64748b", marginBottom: 12 },
  weekEmptyActions: { display: "flex", flexWrap: "wrap", gap: 8 },
  inlineActionButton: { appearance: "none", border: "1px solid #dbe3ee", background: "#fff", color: "#0f172a", borderRadius: 12, padding: "9px 10px", fontSize: 12, fontWeight: 800, cursor: "pointer" },
  inlineGhostButton: { appearance: "none", border: "1px solid #cbd5e1", background: "#fff", color: "#334155", borderRadius: 12, padding: "9px 10px", fontSize: 12, fontWeight: 700, cursor: "pointer", textDecoration: "none" },
  inlineLinkButton: { display: "inline-flex", alignItems: "center", justifyContent: "center", border: "1px solid #0f172a", background: "#0f172a", color: "#fff", borderRadius: 12, padding: "9px 10px", fontSize: 12, fontWeight: 800, textDecoration: "none" },
  blockCard: { border: "1px solid", borderRadius: 18, padding: 12 },
  blockTop: { display: "flex", justifyContent: "space-between", gap: 8, alignItems: "center", marginBottom: 10 },
  blockTopActions: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" },
  categoryChip: { display: "inline-flex", alignItems: "center", justifyContent: "center", borderRadius: 999, padding: "6px 10px", fontSize: 12, fontWeight: 800 },
  statusChip: { display: "inline-flex", alignItems: "center", justifyContent: "center", borderRadius: 999, padding: "6px 10px", fontSize: 11, fontWeight: 900, border: "1px solid" },
  statusChipPlanned: { background: "#eff6ff", color: "#1d4ed8", borderColor: "#bfdbfe" },
  statusChipDone: { background: "#f1f5f9", color: "#475569", borderColor: "#cbd5e1" },
  deleteInlineButton: { appearance: "none", border: "none", background: "transparent", color: "#7f1d1d", fontSize: 12, fontWeight: 800, cursor: "pointer" },
  blockTitle: { fontSize: 16, fontWeight: 800, color: "#0f172a", marginBottom: 4 },
  blockTime: { fontSize: 13, fontWeight: 700, color: "#475569", marginBottom: 8 },
  blockTimeMuted: { fontSize: 13, fontWeight: 700, color: "#94a3b8", marginBottom: 8 },
  blockContent: { fontSize: 14, lineHeight: 1.55, color: "#334155", whiteSpace: "pre-wrap" },
  blockContentMuted: { fontSize: 13, lineHeight: 1.5, color: "#64748b" },
  blockFooter: { marginTop: 12, display: "flex", gap: 8, flexWrap: "wrap" },
  inlineAddCard: { border: "1px dashed #cbd5e1", background: "#ffffff", borderRadius: 18, padding: 12 },
  inlineAddTitle: { fontSize: 13, fontWeight: 800, color: "#475569", marginBottom: 10, textTransform: "uppercase", letterSpacing: "0.06em" },
  inlineAddActions: { display: "grid", gap: 8, marginBottom: 8 },
  inlineMiniActions: { display: "grid", gap: 8 },
  smallGhostButton: { appearance: "none", border: "1px solid #cbd5e1", background: "#fff", color: "#334155", borderRadius: 10, padding: "8px 10px", fontWeight: 700, fontSize: 12, cursor: "pointer", textDecoration: "none" },
  smallLinkButton: { display: "inline-flex", alignItems: "center", justifyContent: "center", border: "1px solid #0f172a", background: "#0f172a", color: "#fff", borderRadius: 10, padding: "8px 10px", fontWeight: 700, fontSize: 12, textDecoration: "none" },
  dayLayout: { display: "grid", gridTemplateColumns: "minmax(0, 1.65fr) minmax(300px, 0.55fr)", gap: 18, alignItems: "start", marginBottom: 20 },
  dayMain: { display: "grid", gap: 16 },
  dayHeroCard: { background: "#fff", border: "1px solid rgba(15,23,42,0.08)", borderRadius: 24, padding: 22, boxShadow: "0 12px 36px rgba(15,23,42,0.05)" },
  dayTitle: { margin: 0, fontSize: 32, fontWeight: 800, color: "#0f172a" },
  dayText: { margin: "10px 0 0", color: "#475569", lineHeight: 1.65, fontSize: 15 },
  dayBlocksWrap: { display: "grid", gap: 16 },
  dayEmptyCard: { background: "#fff", border: "1px dashed #cbd5e1", borderRadius: 22, padding: 28, textAlign: "center" },
  dayEmptyTitle: { fontSize: 22, fontWeight: 800, color: "#0f172a", marginBottom: 8 },
  dayEmptyText: { margin: 0, color: "#64748b", lineHeight: 1.6 },
  dayBlockCard: { background: "#fff", border: "1px solid", borderRadius: 24, overflow: "hidden", boxShadow: "0 12px 36px rgba(15,23,42,0.05)" },
  dayBlockBanner: { padding: "20px 22px", color: "#fff" },
  dayBlockBannerTitle: { fontSize: 28, fontWeight: 800, lineHeight: 1.1 },
  dayBlockBannerTime: { marginTop: 8, fontSize: 16, fontWeight: 700, opacity: 0.92 },
  dayBlockBody: { padding: 22 },
  dayBlockMetaRow: { display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center", flexWrap: "wrap", marginBottom: 14 },
  dayMetaLeft: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" },
  dayBlockActionRow: { display: "flex", gap: 8, flexWrap: "wrap" },
  dayBlockContent: { color: "#334155", fontSize: 15, lineHeight: 1.7, whiteSpace: "pre-wrap" },
  daySidebar: { display: "grid", gap: 16, position: "sticky", top: 24, alignSelf: "start" },
  sidebarCard: { background: "#fff", border: "1px solid rgba(15,23,42,0.08)", borderRadius: 24, padding: 20, boxShadow: "0 12px 36px rgba(15,23,42,0.05)" },
  sidebarTitle: { fontSize: 18, fontWeight: 800, color: "#0f172a", marginBottom: 12 },
  sidebarNote: { width: "100%", borderRadius: 18, border: "1px solid #f5e48d", background: "#fffad1", padding: "12px 14px", resize: "vertical", outline: "none", minHeight: 170, lineHeight: 1.55, color: "#334155", fontSize: 14 },
  miniMonthLabel: { fontSize: 16, fontWeight: 800, color: "#0f172a", marginBottom: 10 },
  miniCalendarGrid: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0, 1fr))", gap: 6, alignItems: "center" },
  miniWeekday: { textAlign: "center", fontSize: 11, fontWeight: 800, color: "#64748b", paddingBottom: 4 },
  miniDateButton: { appearance: "none", border: "1px solid transparent", background: "#fff", color: "#0f172a", borderRadius: 12, minHeight: 42, padding: "6px 4px", fontWeight: 700, fontSize: 12, cursor: "pointer", position: "relative", display: "grid", placeItems: "center" },
  miniDateSelected: { background: "#dbeafe", color: "#1d4ed8", borderColor: "#93c5fd" },
  miniDateMuted: { opacity: 0.35 },
  miniDot: { width: 6, height: 6, borderRadius: 999, background: "#0f172a", position: "absolute", bottom: 5 },
  monthSection: { marginBottom: 20 },
  monthWeekdays: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0, 1fr))", gap: 10, marginBottom: 10 },
  monthWeekday: { textAlign: "center", fontWeight: 800, color: "#475569", fontSize: 14, padding: "8px 0" },
  monthGrid: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0, 1fr))", gap: 10 },
  monthCell: { appearance: "none", background: "#fff", border: "1px solid rgba(15,23,42,0.08)", borderRadius: 22, minHeight: 140, padding: 14, textAlign: "left", cursor: "pointer", boxShadow: "0 10px 28px rgba(15,23,42,0.04)" },
  monthCellMuted: { opacity: 0.5 },
  monthCellToday: { boxShadow: "0 0 0 2px rgba(59,130,246,0.18), 0 10px 28px rgba(15,23,42,0.05)", background: "#fbfdff" },
  monthCellTop: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, marginBottom: 12 },
  monthDateNumber: { fontSize: 18, fontWeight: 800, color: "#0f172a" },
  todayMiniBadge: { fontSize: 11, fontWeight: 800, color: "#1d4ed8", background: "#dbeafe", borderRadius: 999, padding: "4px 8px" },
  monthSignals: { display: "grid", gap: 6 },
  monthSignal: { height: 8, borderRadius: 999 },
  moreText: { marginTop: 2, fontSize: 12, fontWeight: 700, color: "#64748b" },
  monthNoteHint: { marginTop: 10, fontSize: 12, fontWeight: 700, color: "#475569" },
  flowCard: { background: "#fff", border: "1px solid rgba(15,23,42,0.08)", borderRadius: 24, padding: 22, boxShadow: "0 12px 34px rgba(15,23,42,0.05)", display: "flex", justifyContent: "space-between", gap: 16, alignItems: "center", flexWrap: "wrap" },
  flowTitle: { fontSize: 20, fontWeight: 800, color: "#0f172a" },
  flowText: { marginTop: 6, color: "#64748b", lineHeight: 1.6, fontSize: 14 },
  flowButtons: { display: "flex", gap: 10, flexWrap: "wrap" },
  flowButton: { display: "inline-flex", alignItems: "center", justifyContent: "center", minHeight: 42, padding: "0 14px", borderRadius: 12, border: "1px solid #dbe3ee", background: "#fff", color: "#0f172a", textDecoration: "none", fontWeight: 800 },
};
