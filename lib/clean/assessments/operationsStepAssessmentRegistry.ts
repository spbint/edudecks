...
const LATER_STEP_SPECS: OperationsStepSpec[] = [
  {
    ...
    cases: [
      {
        title: "Equal groups of apples",
        prompt: "There are 3 equal groups. Each group has 4 apples. How many apples are there altogether?",
        practicePrompt: "Count 3 equal groups with 4 apples in each group. Choose the total.",
        options: ["12", "7", "3", "4"],
        answer: "12",
        visual: groups("3 equal groups of 4 apples.", [4, 4, 4], ["apples", "apples", "apples"]),
        cluster: "equal-groups-total",
        clusterTitle: "Equal groups and totals",
        misconceptionTargets: ["groups-vs-size-confusion"],
        feedback: "4 + 4 + 4 = 12.",
      },
      {
        title: "Equal groups of stars",
        prompt: "There are 4 equal groups. Each group has 2 stars. How many stars are there altogether?",
        practicePrompt: "Count 4 equal groups with 2 stars in each group. Choose the total.",
        options: ["8", "6", "4", "2"],
        answer: "8",
        visual: groups("4 equal groups of 2 stars.", [2, 2, 2, 2], ["stars", "stars", "stars", "stars"]),
        cluster: "equal-groups-total",
        clusterTitle: "Equal groups and totals",
        misconceptionTargets: ["counts-groups-not-objects"],
        feedback: "2 + 2 + 2 + 2 = 8.",
      },
      {
        title: "Equal groups of dots",
        prompt: "There are 5 equal groups. Each group has 4 dots. How many dots are there altogether?",
        practicePrompt: "Count 5 equal groups with 4 dots in each group. Choose the total.",
        options: ["20", "9", "10", "16"],
        answer: "20",
        visual: groups("5 equal groups of 4 dots.", [4, 4, 4, 4, 4], ["dots", "dots", "dots", "dots", "dots"]),
        cluster: "equal-groups-total",
        clusterTitle: "Equal groups and totals",
        misconceptionTargets: ["repeated-addition-total-error"],
        feedback: "4 + 4 + 4 + 4 + 4 = 20.",
      },
      {
        title: "How many in each group",
        prompt: "Look at the equal groups. How many are in each group?",
        practicePrompt: "Look at 3 baskets with 2 bananas in each basket. Choose how many are in each group.",
        options: ["2", "3", "5", "6"],
        answer: "2",
        visual: groups("3 baskets with 2 bananas in each basket.", [2, 2, 2], ["bananas", "bananas", "bananas"]),
        cluster: "group-size",
        clusterTitle: "How many in each group",
        misconceptionTargets: ["total-vs-group-size-confusion"],
        feedback: "Each basket has 2 bananas.",
      },
      {
        title: "How many groups",
        prompt: "Look at the equal groups. How many groups are there?",
        practicePrompt: "Look at 4 fishbowls with 2 fish in each bowl. Choose how many groups there are.",
        options: ["4", "2", "6", "8"],
        answer: "4",
        visual: groups("4 fishbowls with 2 fish in each bowl.", [2, 2, 2, 2], ["fish", "fish", "fish", "fish"]),
        cluster: "group-count",
        clusterTitle: "How many groups",
        misconceptionTargets: ["group-count-vs-size-confusion"],
        feedback: "There are 4 equal groups.",
      },
      {
        title: "Banana repeated addition",
        prompt: "Which repeated addition sentence matches the picture?",
        practicePrompt: "Choose the repeated addition sentence for 3 baskets with 2 bananas in each basket.",
        options: ["2 + 2 + 2 = 6", "3 + 3 = 6", "2 + 3 = 5", "6 + 2 = 8"],
        answer: "2 + 2 + 2 = 6",
        visual: groups("3 equal groups of 2 bananas.", [2, 2, 2], ["bananas", "bananas", "bananas"]),
        cluster: "repeated-addition",
        clusterTitle: "Repeated addition",
        misconceptionTargets: ["adds-groups-and-size"],
        feedback: "There are 3 groups of 2, so 2 + 2 + 2 = 6.",
      },
      {
        title: "Fish repeated addition",
        prompt: "Which repeated addition sentence matches the picture?",
        practicePrompt: "Choose the repeated addition sentence for 4 fishbowls with 2 fish in each bowl.",
        options: ["2 + 2 + 2 + 2 = 8", "4 + 2 = 6", "4 + 4 = 8", "8 + 2 = 10"],
        answer: "2 + 2 + 2 + 2 = 8",
        visual: groups("4 equal groups of 2 fish.", [2, 2, 2, 2], ["fish", "fish", "fish", "fish"]),
        cluster: "repeated-addition",
        clusterTitle: "Repeated addition",
        misconceptionTargets: ["repeated-addition-length-error"],
        feedback: "There are 4 groups of 2, so 2 + 2 + 2 + 2 = 8.",
      },
      {
        title: "Cookie repeated addition",
        prompt: "Which repeated addition sentence matches the picture?",
        practicePrompt: "Choose the repeated addition sentence for 5 plates with 3 cookies on each plate.",
        options: ["3 + 3 + 3 + 3 + 3 = 15", "5 + 3 = 8", "5 + 5 + 5 = 15", "3 + 5 = 8"],
        answer: "3 + 3 + 3 + 3 + 3 = 15",
        visual: groups("5 plates with 3 cookies on each plate.", [3, 3, 3, 3, 3], ["cookies", "cookies", "cookies", "cookies", "cookies"]),
        cluster: "repeated-addition",
        clusterTitle: "Repeated addition",
        misconceptionTargets: ["groups-as-addend-error"],
        feedback: "There are 5 groups of 3, so 3 + 3 + 3 + 3 + 3 = 15.",
      },
      {
        title: "Match 4 groups of 2",
        prompt: "Which picture shows 4 groups of 2?",
        practicePrompt: "Choose the picture description with 4 groups and 2 objects in each group.",
        options: [
          "4 groups with 2 objects in each group",
          "2 groups with 4 objects in each group",
          "4 objects in one group",
          "2 objects in one group",
        ],
        answer: "4 groups with 2 objects in each group",
        visual: groups("4 groups of 2.", [2, 2, 2, 2], ["objects", "objects", "objects", "objects"]),
        cluster: "description-match",
        clusterTitle: "Match descriptions",
        misconceptionTargets: ["group-count-and-size-reversed"],
        feedback: "4 groups of 2 means four equal groups with 2 in each group.",
      },
      {
        title: "Match 3 groups of 5",
        prompt: "Which picture shows 3 groups of 5?",
        practicePrompt: "Choose the picture description with 3 groups and 5 objects in each group.",
        options: [
          "3 groups with 5 objects in each group",
          "5 groups with 3 objects in each group",
          "3 objects altogether",
          "5 objects altogether",
        ],
        answer: "3 groups with 5 objects in each group",
        visual: groups("3 groups of 5.", [5, 5, 5], ["objects", "objects", "objects"]),
        cluster: "description-match",
        clusterTitle: "Match descriptions",
        misconceptionTargets: ["total-instead-of-groups"],
        feedback: "3 groups of 5 has 3 equal groups, and each group has 5 objects.",
      },
      {
        title: "Match 5 groups of 3",
        prompt: "Which picture shows 5 groups of 3?",
        practicePrompt: "Choose the picture description with 5 groups and 3 objects in each group.",
        options: [
          "5 groups with 3 objects in each group",
          "3 groups with 5 objects in each group",
          "5 objects altogether",
        ...
        answer: "5 groups with 3 objects in each group",
        visual: groups("5 groups of 3.", [3, 3, 3, 3, 3], ["objects", "objects", "objects", "objects", "objects"]),
        cluster: "description-match",
        clusterTitle: "Match descriptions",
        misconceptionTargets: ["group-count-and-size-reversed"],
        feedback: "5 groups of 3 has 5 equal groups, and each group has 3 objects.",
      },
      {
        title: "Crayon boxes",
        prompt: "There are 3 boxes. Each box has 4 crayons. How many crayons are there in all?",
        practicePrompt: "Use equal groups to solve the crayon story.",
        options: ["12", "7", "9", "4"],
        answer: "12",
        visual: groups("3 boxes with 4 crayons in each box.", [4, 4, 4], ["crayons", "crayons", "crayons"]),
        cluster: "word-problems",
        clusterTitle: "Equal groups word problems",
        misconceptionTargets: ["adds-groups-and-size"],
        feedback: "4 + 4 + 4 = 12.",
      },
      {
        title: "Flower vases",
        prompt: "There are 5 vases. Each vase has 2 flowers. How many flowers are there in all?",
        practicePrompt: "Use equal groups to solve the flower story.",
        options: ["10", "7", "5", "2"],
        answer: "10",
        visual: groups("5 vases with 2 flowers in each vase.", [2, 2, 2, 2, 2], ["flowers", "flowers", "flowers", "flowers", "flowers"]),
        cluster: "word-problems",
        clusterTitle: "Equal groups word problems",
        misconceptionTargets: ["counts-vases-only"],
        feedback: "2 + 2 + 2 + 2 + 2 = 10.",
      },
      {
        title: "Grape plates",
        prompt: "There are 4 plates. Each plate has 3 grapes. How many grapes are there in all?",
        practicePrompt: "Use equal groups to solve the grape story.",
        options: ["12", "7", "9", "4"],
        answer: "12",
        visual: groups("4 plates with 3 grapes on each plate.", [3, 3, 3, 3], ["grapes", "grapes", "grapes", "grapes"]),
        cluster: "word-problems",
        clusterTitle: "Equal groups word problems",
        misconceptionTargets: ["misses-one-group"],
        feedback: "3 + 3 + 3 + 3 = 12.",
      },
      {
        title: "Total for 4 groups of 5",
        prompt: "What is the total?",
        practicePrompt: "Find the total for 4 groups of 5.",
        options: ["20", "9", "16", "10"],
        answer: "20",
        visual: groups("4 groups of 5.", [5, 5, 5, 5], ["objects", "objects", "objects", "objects"]),
        cluster: "equal-groups-total",
        clusterTitle: "Equal groups and totals",
        misconceptionTargets: ["repeated-addition-total-error"],
        feedback: "5 + 5 + 5 + 5 = 20.",
      ...
      {
        title: "Repeated addition for 4 groups of 2",
        prompt: "Which repeated addition sentence matches 4 groups of 2?",
        practicePrompt: "Choose the sentence that adds 2 four times.",
        options: ["2 + 2 + 2 + 2 = 8", "4 + 4 = 8", "4 + 2 = 6", "2 + 4 = 6"],
        answer: "2 + 2 + 2 + 2 = 8",
        visual: groups("4 groups of 2.", [2, 2, 2, 2], ["objects", "objects", "objects", "objects"]),
        cluster: "repeated-addition",
        clusterTitle: "Repeated addition",
        misconceptionTargets: ["adds-groups-and-size"],
        feedback: "4 groups of 2 means 2 + 2 + 2 + 2 = 8.",
      },
      {
        title: "Equal or not equal",
        prompt: "Which picture shows equal groups?",
        practicePrompt: "Choose the picture description where each group has the same number of objects.",
        options: [
          "Three groups with 4 objects in each group",
          "One group with 3, one group with 4, and one group with 5",
          "One group with 2 and one group with 5",
          "Three groups with different numbers",
        ],
        answer: "Three groups with 4 objects in each group",
        visual: groups("Three equal groups with 4 objects in each group.", [4, 4, 4], ["objects", "objects", "objects"]),
        cluster: "equal-or-not",
        clusterTitle: "Equal or not equal groups",
        misconceptionTargets: ["unequal-groups-accepted"],
        feedback: "Equal groups have the same number in each group.",
      },
    ],
  },
  {
