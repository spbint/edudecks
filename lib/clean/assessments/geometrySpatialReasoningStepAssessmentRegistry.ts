...
const RAW_GEOMETRY_CASES: RawGeometryCase[][] = [
  ...
  [
    ["Classroom layout", "Which choice belongs in a classroom layout design?", "Use the worksheet classroom objects and layout rules.", ["desks, teacher table, shelves and walking space", "only road signs", "only coins"], "desks, teacher table, shelves and walking space", numbers("Classroom layout designer.", ["desks", "teacher table", "shelves", "paths"]), "classroom-layout", "Classroom layout", ["context-mixup"]],
    ["Classroom movement", "Why should a classroom plan leave clear paths?", "A layout model must support movement through the space.", ["so people can move safely", "so the walls disappear", "so the room has no furniture"], "so people can move safely", numbers("Classroom layout paths.", ["door", "desks", "clear path"]), "classroom-layout", "Classroom layout", ["ignores-layout-constraint"]],
    ["Floor plan investigation", "What does a floor plan help you investigate?", "Use the worksheet plan to compare rooms and routes.", ["rooms, doors, distances and movement paths", "weather only", "spelling words"], "rooms, doors, distances and movement paths", numbers("Floor plan investigation.", ["rooms", "doors", "routes"]), "floor-plans", "Floor plan investigation", ["representation-choice-gap"]],
    ["Floor plan interpretation", "A room is closest to the entrance on a floor plan. What does closest mean?", "Interpret relative position on the plan.", ["shortest distance from the entrance", "largest label", "darkest colour"], "shortest distance from the entrance", numbers("Floor plan distances.", ["entrance", "rooms"]), "floor-plans", "Floor plan investigation", ["distance-language-gap"]],
    ["Architecture shapes", "Which geometric idea helps analyse a building front?", "Look for shapes and symmetry in architecture.", ["rectangles, triangles, symmetry and angles", "only food groups", "only money totals"], "rectangles, triangles, symmetry and angles", numbers("Architecture shape analysis.", ["windows", "roof", "symmetry"]), "architecture", "Geometry in architecture", ["architecture-geometry-link-gap"]],
    ["Architecture reason", "Why might an architect use rectangles in a plan?", "Connect shapes to practical design.", ["rectangles can model rooms and walls clearly", "rectangles cannot be measured", "rectangles remove doors"], "rectangles can model rooms and walls clearly", numbers("Architecture plan.", ["rectangle room", "wall"]), "architecture", "Geometry in architecture", ["shape-purpose-gap"]],
    ["Block structure view", "A block structure is shown from the front and top. What are you interpreting?", "Use different views of the same structure.", ["views of a 3D structure", "coin values", "time intervals"], "views of a 3D structure", numbers("Block structure view task.", ["front", "top", "side"]), "structures", "Build and interpret structures", ["viewpoint-confusion"]],
    ["Build structure", "Which information helps rebuild a cube structure?", "Use views, layers, and cube counts.", ["front view, top view and cube positions", "only the colour of one cube", "only the worksheet title"], "front view, top view and cube positions", numbers("Block structure builder.", ["front", "top", "cubes"]), "structures", "Build and interpret structures", ["single-view-only"]],
    ["Scale drawing", "A scale drawing uses 1 square = 1 metre. What does 5 squares represent?", "Apply the scale to interpret space.", ["5 metres", "1 metre", "10 centimetres"], "5 metres", groups("Scale drawing planner.", [1, 1, 1, 1, 1], ["m", "m", "m", "m", "m"]), "scale-drawing", "Scale drawing", ["scale-factor-error"]],
    ["Map interpretation", "Which tool helps interpret direction on a map?", "Use the worksheet map features.", ["compass rose", "shopping receipt", "fraction strip"], "compass rose", numbers("Map interpretation grid.", ["north", "south", "east", "west"]), "maps", "Map interpretation", ["map-feature-gap"]],
    ["Spatial design challenge", "What should a spatial design challenge include?", "A good design explains placement and reasons.", ["layout, labels, measurements and explanation", "random shapes with no labels", "answers only"], "layout, labels, measurements and explanation", numbers("Spatial design challenge.", ["layout", "labels", "reasons"]), "spatial-design", "Spatial design", ["unsupported-design-choice"]],
    ["Think and explain", "Why is geometry useful for modelling and interpreting space?", "Connect classroom plans, buildings, structures, scale and maps.", ["it helps plan, build, navigate and explain spaces", "it only names colours", "it prevents design"], "it helps plan, build, navigate and explain spaces", numbers("Geometry modelling summary.", ["plan", "build", "map", "explain"]), "communication", "Think and explain", ["model-purpose-gap"]],
  ],
  [
    ["Visualise and describe", "A structure is shown from the front and top. What should a clear description include?", "Describe visible parts and position.", ["shape, position, view and key features", "only the colour", "only the page number"], "shape, position, view and key features", numbers("Spatial visualisation task.", ["front", "top", "features"]), "visualisation", "Visualise and describe", ["vague-spatial-description"]],
    ["Describe hidden cubes", "Why might a top view help when describing a block structure?", "A top view shows positions that may be hidden from the front.", ["it shows where cubes sit on the grid", "it changes cube sizes", "it removes the structure"], "it shows where cubes sit on the grid", numbers("Block view description.", ["top view", "cube positions"]), "visualisation", "Visualise and describe", ["single-view-only"]],
    ["Map analysis", "What should a strong map explanation use?", "Analyse directions, coordinates and evidence from the map.", ["directions, coordinates and evidence", "guesswork only", "unrelated numbers"], "directions, coordinates and evidence", numbers("Map analysis and explanation.", ["north", "coordinates", "route"]), "map-analysis", "Map analysis and explanation", ["unsupported-map-claim"]],
    ["Map route judgement", "A route crosses an obstacle on the map. What should you explain?", "Judge whether the route is practical.", ["why the route needs changing", "why obstacles do not matter", "only the line colour"], "why the route needs changing", numbers("Map route analysis.", ["route", "obstacle", "revise"]), "map-analysis", "Map analysis and explanation", ["ignores-spatial-constraint"]],
    ["Compare layouts", "Which comparison gives the strongest justification?", "Use evidence about space and movement.", ["Layout A leaves a clear path to the door", "Layout A is nicer", "Layout B has more colours"], "Layout A leaves a clear path to the door", numbers("Layout comparison justification.", ["layout A", "layout B", "door path"]), "compare-justify", "Compare and justify", ["preference-not-evidence"]],
    ["Justify design choice", "Why might one room layout be better than another?", "Use practical spatial judgement.", ["it uses space well and avoids blocking movement", "it has the longest name", "it ignores the door"], "it uses space well and avoids blocking movement", numbers("Room spatial judgement.", ["space", "door", "movement"]), "compare-justify", "Compare and justify", ["layout-reasoning-gap"]],
    ["Rotate and predict", "An L-shape is rotated a quarter turn clockwise. What should your prediction keep the same?", "A rotation changes orientation, not size.", ["same size and shape", "double size", "different number of sides"], "same size and shape", numbers("Rotation prediction grid.", ["L-shape", "quarter turn"]), "rotation-prediction", "Rotate and predict", ["rotation-changes-size"]],
    ["Rotation explanation", "Which sentence clearly explains a rotation?", "Name the turn and direction.", ["The shape turned a quarter turn clockwise", "The shape moved somehow", "The shape became bigger"], "The shape turned a quarter turn clockwise", numbers("Rotation explanation.", ["quarter turn", "clockwise"]), "rotation-prediction", "Rotate and predict", ["vague-transformation-language"]],
    ["Real-life spatial judgement", "A desk blocks the doorway in a room plan. What is the best judgement?", "Evaluate whether the plan works in real life.", ["the plan should be changed", "the doorway should be ignored", "the desk is not part of geometry"], "the plan should be changed", numbers("Room spatial judgement.", ["desk", "doorway", "blocked"]), "real-life-judgement", "Real-life spatial judgement", ["constraint-not-checked"]],
    ["Build draw explain", "After building a cube structure, what should the drawing and explanation show?", "Connect the model to a clear representation.", ["cube positions, views and reasoning", "only the title", "only one random cube"], "cube positions, views and reasoning", numbers("Build, draw and explain structure.", ["build", "draw", "explain"]), "build-draw-explain", "Build, draw and explain", ["model-representation-gap"]],
    ["Design and evaluate", "Which evaluation best explains a park design?", "Use criteria from the design task.", ["The path connects areas and leaves open space", "The park is good because I said so", "The design has no labels"], "The path connects areas and leaves open space", numbers("Design evaluate planner.", ["path", "areas", "open space"]), "design-evaluate", "Design and evaluate", ["unsupported-design-choice"]],
    ["Think and reflect", "What does refining spatial judgement mean?", "Reflect on checking, explaining and improving spatial ideas.", ["checking whether a spatial idea makes sense and explaining why", "guessing without evidence", "avoiding maps and diagrams"], "checking whether a spatial idea makes sense and explaining why", numbers("Spatial reflection prompt.", ["check", "explain", "improve"]), "reflection", "Think and reflect", ["reflection-purpose-gap"]],
  ],
];
