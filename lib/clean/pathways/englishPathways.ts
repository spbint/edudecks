...
const ADDITIONAL_FOUNDATIONAL_WORD_BUILDER_STEPS: EnglishStepInput[] = [
  ...
  {
    id: 23,
    stepKey: "kf-u021-cvc-word-fluency",
    title: "CVC Word Fluency",
    meaning: "Build increasingly fluent reading of familiar CVC words while maintaining accurate sound-by-sound decoding.",
    skillFocus: "CVC word reading fluency",
    learningIntention: "Today I am learning to read familiar CVC words more smoothly and accurately.",
    successCriteria: ["I can read familiar CVC words with less hesitation.", "I can check the sounds when a word is unfamiliar."],
    practiceActivity: "Read, reread, sort, and practise short sets of CVC words while keeping accuracy more important than speed.",
    evidenceExamples: ["the completed CVC Word Fluency worksheet", "a short repeated-reading sample", "a parent note about accurate, increasingly automatic word reading"],
    assessmentCheck: "Ask the learner to read a mixed set of familiar CVC words, noting accuracy and sensible checking of unfamiliar words.",
    nextStep: "Carry accurate CVC word reading into short connected text and decodable sentences.",
    reportLanguage: "The learner is developing more fluent and accurate reading of familiar CVC words.",
  },
];
...
const ADDITIONAL_MS_WORD_BUILDER_STEPS: EnglishStepInput[] = [
  createWordBuilderStep(1, "ms-u001-suffix-ion", "Suffix Ion", "Explore how -ion forms nouns connected with actions, processes, or results.", "-ion suffix meaning and derived nouns", "Today I am learning how -ion relates a word to an action or result.", ["I can identify -ion in a word.", "I can connect an -ion word with its base or related word."], "Build, sort, and discuss -ion words, connecting each derived word with its base and meaning.", "Ask the learner to explain several -ion word relationships.", "Compare other suffixes that form related nouns.", "The learner is developing understanding of -ion as a meaningful suffix in related word families."),
  createWordBuilderStep(2, "ms-u002-suffix-ian-an", "Suffix Ian An", "Explore how -ian and -an can describe people, places, or relationships connected with a base word.", "-ian and -an suffix meaning", "Today I am learning how -ian and -an contribute meaning to related words.", ["I can identify -ian or -an.", "I can explain a relationship between a base word and a derived word."], "Sort and build -ian and -an words, then explain the connection between each base and derived form.", "Ask the learner to explain familiar -ian and -an word relationships.", "Compare other suffixes that describe people, places, or relationships.", "The learner is beginning to use -ian and -an to interpret related words and vocabulary."),
  createWordBuilderStep(3, "ms-u003-suffix-ive", "Suffix Ive", "Explore how -ive forms words that describe a quality, tendency, or relation to an action.", "-ive suffix meaning and word building", "Today I am learning how -ive contributes meaning to a related word.", ["I can identify -ive.", "I can connect an -ive word with its base or meaning."], "Build and compare -ive words, discussing the relationship between each derived word and its base.", "Ask the learner to explain familiar -ive word relationships.", "Use suffix knowledge to investigate related academic vocabulary.", "The learner is developing awareness of -ive as a meaningful suffix in related word families."),
  createWordBuilderStep(4, "ms-u004-suffix-al", "Suffix Al", "Explore how -al forms words related to an action, quality, or subject area.", "-al suffix meaning and derived words", "Today I am learning how -al connects a derived word with its base meaning.", ["I can identify -al.", "I can explain a familiar -al word using its base relationship."], "Sort, build, and use -al words, discussing how the suffix changes the word's role or meaning.", "Ask the learner to explain several -al word relationships.", "Compare other suffixes that form adjectives or related vocabulary.", "The learner is beginning to connect -al words with their bases and related meanings."),
  createWordBuilderStep(5, "ms-u005-suffix-ic", "Suffix Ic", "Explore how -ic forms words that describe a connection with a subject, quality, or idea.", "-ic suffix meaning and vocabulary", "Today I am learning how -ic connects a word with a subject or quality.", ["I can identify -ic.", "I can explain a familiar -ic word through its base relationship."], "Build and sort -ic words, then use them in short explanations or sentences.", "Ask the learner to explain familiar -ic word relationships.", "Use related word families to interpret subject vocabulary.", "The learner is developing understanding of -ic as a meaningful suffix in subject-related vocabulary."),
  createWordBuilderStep(6, "ms-u006-suffix-ure", "Suffix Ure", "Explore how -ure forms related nouns connected with actions, processes, or conditions.", "-ure suffix meaning and word families", "Today I am learning how -ure connects related words in a word family.", ["I can identify -ure.", "I can connect a -ure word with a related base or meaning."], "Build, sort, and discuss -ure words, using word-family relationships to explain meaning.", "Ask the learner to explain familiar -ure word relationships.", "Compare further suffix families in academic and everyday vocabulary.", "The learner is beginning to use -ure word-family relationships to support morphology and vocabulary."),
  createWordBuilderStep(7, "ms-u007-suffix-ance-ence", "Suffix Ance Ence", "Compare -ance and -ence in related nouns describing actions, states, or qualities.", "-ance and -ence suffix families", "Today I am learning to compare related -ance and -ence words.", ["I can identify -ance or -ence.", "I can connect a derived word with its base or related word."], "Sort and build -ance and -ence words, discussing meaning, word families, and spelling patterns.", "Ask the learner to explain several -ance and -ence relationships.", "Use related word families to support spelling of less familiar nouns.", "The learner is developing awareness of -ance and -ence as related suffix patterns in word families."),
  createWordBuilderStep(8, "ms-u008-suffix-ant-ent", "Suffix Ant Ent", "Explore -ant and -ent in derived words connected with people, actions, or qualities.", "-ant and -ent suffix meaning and spelling", "Today I am learning to compare -ant and -ent in related words.", ["I can identify -ant or -ent.", "I can explain a familiar derived word using its base relationship."], "Build and sort -ant and -ent words, connecting spelling and meaning to related word families.", "Ask the learner to explain familiar -ant and -ent relationships.", "Compare additional suffix families and use them when checking spelling.", "The learner is beginning to use -ant and -ent word-family knowledge when interpreting and spelling words."),
  createWordBuilderStep(9, "ms-u009-suffix-able-ible", "Suffix Able Ible", "Compare -able and -ible in derived words and use base-word relationships to support spelling and meaning.", "-able and -ible suffix comparison", "Today I am learning to compare -able and -ible words using meaning and word relationships.", ["I can identify -able or -ible.", "I can use a related word or base to help explain a spelling."], "Sort, build, and compare -able and -ible words, discussing the base relationship and derived meaning.", "Ask the learner to explain the spelling and meaning relationship in familiar examples.", "Use morphology and related words to check more advanced suffix spellings.", "The learner is developing more advanced understanding of -able and -ible word families."),
  createWordBuilderStep(10, "ms-u010-prefix-ad-ac-at", "Prefix Ad Ac At", "Explore related forms of a prefix that can express toward or joining, including spelling changes in derived words.", "ad-, ac-, and at- prefix meaning and assimilation", "Today I am learning how related prefix forms can express toward or joining.", ["I can recognise related prefix forms.", "I can connect a prefix form with the meaning of a familiar word."], "Sort and build ad-, ac-, and at- words, noticing how the form changes while the underlying relationship remains connected.", "Ask the learner to explain the shared idea and identify the form in familiar examples.", "Compare other assimilated or classical prefix forms.", "The learner is beginning to recognise related ad-, ac-, and at- forms in word families."),
  createWordBuilderStep(11, "ms-u011-prefix-ex-e", "Prefix Ex E", "Explore ex- and e- in words connected with out, from, or movement away where supported by the word family.", "ex- and e- prefix meaning and word analysis", "Today I am learning how ex- and e- contribute meaning in related words.", ["I can identify ex- or e- in a familiar word.", "I can use a related word or context to infer meaning."], "Sort, build, and discuss ex- and e- words, connecting each form with its word family and meaning.", "Ask the learner to explain familiar ex- and e- word relationships without relying on unsupported etymology.", "Compare other prefix families that affect meaning and spelling.", "The learner is developing awareness of ex- and e- as related prefix forms in familiar word families."),
  createWordBuilderStep(12, "ms-u012-prefix-ob", "Prefix Ob", "Explore ob- in familiar words and use word-family evidence to support meaning and spelling.", "prefix ob- word analysis", "Today I am learning to recognise and analyse ob- in related words.", ["I can identify ob- in a familiar word.", "I can use context or a related word to discuss its meaning."], "Build and sort ob- words, then explain how the prefix and base contribute to the whole word.", "Ask the learner to analyse several familiar ob- words using context and related forms.", "Continue comparing classical prefix families in vocabulary.", "The learner is beginning to analyse ob- words through prefix, base, and context relationships."),
  createWordBuilderStep(13, "ms-u013-prefix-per", "Prefix Per", "Explore per- in familiar words and use context and related forms to infer meaning.", "prefix per- word analysis", "Today I am learning to recognise and analyse per- in related words.", ["I can identify per- in a familiar word.", "I can discuss the word's meaning using context or related words."], "Sort, build, and use per- words, connecting the prefix with the whole word's meaning.", "Ask the learner to analyse familiar per- words and explain the evidence used.", "Compare per- with other advanced prefix families.", "The learner is developing confidence analysing per- in familiar morphology and vocabulary work."),
  createWordBuilderStep(14, "ms-u014-prefix-pro", "Prefix Pro", "Explore pro- in words connected with forward movement, support, or taking a position where the word family supports that meaning.", "prefix pro- meaning and word analysis", "Today I am learning to recognise and analyse pro- in related words.", ["I can identify pro- in a familiar word.", "I can use context and related words to discuss meaning."], "Build and sort pro- words, then explain how the prefix and base contribute to each word.", "Ask the learner to analyse familiar pro- words and explain the evidence used.", "Use advanced prefix knowledge to infer meaning in academic vocabulary.", "The learner is beginning to use pro- and word-family evidence to analyse familiar vocabulary."),
];

const ADDITIONAL_HSF_WORD_BUILDER_STEPS: EnglishStepInput[] = ([
  createWordBuilderStep(1, "hsf-u001-prefix-contra-counter", "Prefix Contra Counter", "Explore contra- and counter- in words connected with against, opposite, or in response to.", "contra- and counter- prefix meaning", "Today I am learning how contra- and counter- can express opposition or response.", ["I can identify contra- or counter-.", "I can explain or infer the meaning of a familiar word."], "Sort, build, and analyse contra- and counter- words using context and related word parts.", "Ask the learner to explain familiar contra- and counter- words using word-part evidence.", "Compare further advanced prefixes in academic vocabulary.", "The learner is developing understanding of contra- and counter- in advanced word families."),
  createWordBuilderStep(2, "hsf-u002-prefix-multi", "Prefix Multi", "Explore multi- in words connected with many or more than one and use word parts and context to interpret related vocabulary.", "prefix multi- meaning and word analysis", "Today I am learning how multi- can show many or more than one in related words.", ["I can identify multi- in a familiar word.", "I can explain or infer the meaning of a multi- word using context."], "Build, sort, and analyse multi- words, then connect the prefix meaning with the whole word.", "Ask the learner to explain familiar multi- words using prefix and context evidence.", "Compare prefixes that express amount, number, or degree.", "The learner is beginning to use multi- and context to interpret advanced vocabulary."),
  createWordBuilderStep(2, "hsf-u003-prefix-super", "Prefix Super", "Explore super- in words connected with above, beyond, or exceptional degree where the word supports that meaning.", "prefix super- meaning and word analysis", "Today I am learning to recognise and analyse super- in related words.", ["I can identify super- in a familiar word.", "I can use context and related words to infer meaning."], "Build, sort, and use super- words, discussing how the prefix contributes to the whole word.", "Ask the learner to analyse familiar super- words using context and word parts.", "Compare prefixes that express degree, position, or excess.", "The learner is beginning to use super- and context to interpret advanced vocabulary."),
  createWordBuilderStep(3, "hsf-u004-prefix-semi", "Prefix Semi", "Explore semi- in words connected with half, partly, or occurring at intervals where appropriate.", "prefix semi- meaning and vocabulary", "Today I am learning how semi- can express half, partly, or an interval.", ["I can identify semi- in a word.", "I can explain or infer the meaning of a familiar semi- word."], "Build and sort semi- words, then connect each word to the relevant meaning in context.", "Ask the learner to explain familiar semi- words using prefix and context evidence.", "Compare prefixes that express degree, frequency, or amount.", "The learner is developing understanding of semi- in advanced word families and academic vocabulary."),
  createWordBuilderStep(4, "hsf-u005-suffix-ary", "Suffix Ary", "Explore -ary in derived words that describe a relationship, place, collection, or quality where supported by the word family.", "-ary suffix meaning and derived vocabulary", "Today I am learning to analyse -ary in related words.", ["I can identify -ary.", "I can connect a derived word with its base or context."], "Build, sort, and analyse -ary words, discussing how the suffix contributes to the derived meaning.", "Ask the learner to explain familiar -ary word relationships using context and base-word evidence.", "Compare other advanced suffix families in academic vocabulary.", "The learner is beginning to analyse -ary in advanced word families and vocabulary."),
  createWordBuilderStep(5, "hsf-u006-suffix-ative", "Suffix Ative", "Explore -ative in derived words that describe a relationship to an action, process, or function.", "-ative suffix meaning and word families", "Today I am learning to analyse -ative in related words.", ["I can identify -ative.", "I can connect a derived word with its base or meaning."], "Build and compare -ative words, using context and word-family relationships to discuss meaning.", "Ask the learner to explain familiar -ative words through their base and context.", "Use suffix analysis to interpret unfamiliar subject vocabulary.", "The learner is developing confidence analysing -ative in advanced derived words."),
  createWordBuilderStep(6, "hsf-u007-suffix-ous", "Suffix Ous", "Explore -ous in derived words that describe a quality or characteristic.", "-ous suffix meaning and derived adjectives", "Today I am learning how -ous can describe a quality or characteristic.", ["I can identify -ous.", "I can explain the quality described by a familiar -ous word."], "Build, sort, and use -ous words, connecting each derived adjective with its base or meaning.", "Ask the learner to explain familiar -ous words using suffix and context evidence.", "Compare other suffixes that form descriptive vocabulary.", "The learner is beginning to use -ous to interpret and build descriptive academic vocabulary."),
  createWordBuilderStep(7, "hsf-u008-suffix-ate", "Suffix Ate", "Explore -ate in derived words and distinguish its role through word-family and sentence context.", "-ate suffix meaning and word analysis", "Today I am learning to analyse -ate in related words and contexts.", ["I can identify -ate in a familiar word.", "I can use context and related words to discuss its function."], "Sort, build, and use -ate words, comparing how the ending contributes to different derived words.", "Ask the learner to explain familiar -ate word relationships using context and base-word evidence.", "Compare other suffixes whose function depends on word family and context.", "The learner is developing more flexible analysis of -ate in advanced word families."),
  createWordBuilderStep(8, "hsf-u009-multiple-affixes", "Multiple Affixes", "Decompose complex words containing more than one meaningful affix and explain how the parts combine.", "multiple-affix analysis and word decomposition", "Today I am learning to find and explain more than one meaningful part in a complex word.", ["I can identify more than one morpheme.", "I can explain how combined word parts affect meaning."], "Break complex words into prefixes, bases, and suffixes, then rebuild and explain the meaning of each part.", "Ask the learner to decompose and explain several complex words without treating the worksheet as mastery evidence.", "Apply multiple-affix analysis to unfamiliar academic vocabulary.", "The learner is beginning to decompose complex words and explain how multiple affixes combine to modify meaning."),
  createWordBuilderStep(9, "hsf-u010-unlock-academic-vocabulary", "Unlock Academic Vocabulary", "Use roots, bases, and affixes to infer the meaning of unfamiliar academic vocabulary.", "morphological vocabulary inference", "Today I am learning to use meaningful word parts to work out unfamiliar academic words.", ["I can identify useful roots, bases, or affixes.", "I can explain an inferred meaning and check it against context."], "Analyse unfamiliar academic words, make a meaning prediction from their parts, and test the prediction in context.", "Ask the learner to explain the word parts and evidence behind an inferred academic meaning.", "Use morphology alongside context, subject knowledge, and reference tools.", "The learner is beginning to use morphology to infer and explain unfamiliar academic vocabulary."),
] as const).map((step, index) => ({ ...step, id: index + 1 }));

const ROOTS_E1_WORD_BUILDER_STEPS: EnglishStepInput[] = [
  createWordBuilderStep(10, "r-u001-root-bio", "Greek Root bio", "Recognise bio as a meaning-bearing root connected with life and use it to analyse related vocabulary.", "Greek root bio and academic word analysis", "Today I am learning to use bio to investigate words connected with life.", ["I can identify bio in a familiar word.", "I can use bio and context to discuss a word's meaning."], "Sort and analyse bio words, then connect the root meaning with each whole word.", "Ask the learner to explain how bio contributes to the meaning of familiar words.", "Use other roots to infer meanings in subject vocabulary.", "The learner is beginning to use the root bio and context to interpret related vocabulary."),
  createWordBuilderStep(11, "r-u002-root-geo", "Greek Root geo", "Recognise geo as a meaning-bearing root connected with earth or land and use it to analyse related vocabulary.", "Greek root geo and academic word analysis", "Today I am learning to use geo to investigate words connected with earth or land.", ["I can identify geo in a familiar word.", "I can use geo and context to discuss a word's meaning."], "Sort and analyse geo words, then connect the root meaning with each whole word.", "Ask the learner to explain how geo contributes to the meaning of familiar words.", "Compare geo with other roots used in geography and science vocabulary.", "The learner is beginning to use the root geo and context to interpret related vocabulary."),
  createWordBuilderStep(12, "r-u003-root-graph-gram", "Greek Roots graph / gram", "Recognise graph and gram as related roots connected with writing, recording, or representing information where supported by the word family.", "Greek roots graph and gram in word analysis", "Today I am learning to use graph and gram to investigate words about writing or recording.", ["I can identify graph or gram in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse graph and gram words, then explain how the root contributes to each word.", "Ask the learner to explain a graph or gram word using root and context evidence.", "Use root knowledge to investigate words about communication and representation.", "The learner is beginning to use graph and gram as clues when analysing related vocabulary."),
  createWordBuilderStep(13, "r-u004-root-phon", "Greek Root phon", "Recognise phon as a meaning-bearing root connected with sound and use it to analyse related vocabulary.", "Greek root phon and sound vocabulary", "Today I am learning to use phon to investigate words connected with sound.", ["I can identify phon in a familiar word.", "I can connect phon with a word's meaning."], "Sort and analyse phon words, then relate the root meaning to familiar sound vocabulary.", "Ask the learner to explain how phon contributes to the meaning of familiar words.", "Compare other roots used in language and communication vocabulary.", "The learner is beginning to use the root phon and context to interpret sound-related vocabulary."),
  createWordBuilderStep(14, "r-u005-root-tele", "Greek Root tele", "Recognise tele as a meaning-bearing root connected with distance or far and use it to analyse related vocabulary.", "Greek root tele and word analysis", "Today I am learning to use tele to investigate words connected with distance.", ["I can identify tele in a familiar word.", "I can use tele and context to discuss a word's meaning."], "Sort and analyse tele words, then connect the root meaning with each whole word.", "Ask the learner to explain how tele contributes to the meaning of familiar words.", "Use roots to infer meaning in technology and communication vocabulary.", "The learner is beginning to use the root tele and context to interpret related vocabulary."),
  createWordBuilderStep(15, "r-u006-root-chron", "Greek Root chron", "Recognise chron as a meaning-bearing root connected with time and use it to analyse related vocabulary.", "Greek root chron and time vocabulary", "Today I am learning to use chron to investigate words connected with time.", ["I can identify chron in a familiar word.", "I can connect chron with a word's meaning."], "Sort and analyse chron words, then explain how the root contributes to each word.", "Ask the learner to explain how chron contributes to the meaning of familiar words.", "Compare other roots used in history and time vocabulary.", "The learner is beginning to use the root chron and context to interpret time-related vocabulary."),
  createWordBuilderStep(16, "r-u007-root-morph", "Greek Root morph", "Recognise morph as a meaning-bearing root connected with form or shape and use it to analyse related vocabulary.", "Greek root morph and word analysis", "Today I am learning to use morph to investigate words connected with form or shape.", ["I can identify morph in a familiar word.", "I can use morph and context to discuss a word's meaning."], "Sort and analyse morph words, then connect the root meaning with each whole word.", "Ask the learner to explain how morph contributes to the meaning of familiar words.", "Use root knowledge to interpret words about form, change, and structure.", "The learner is beginning to use the root morph and context to interpret related vocabulary."),
  createWordBuilderStep(65, "r-u008-root-micro", "Greek Root micro", "Recognise micro as a meaning-bearing root connected with small and use it to analyse related vocabulary.", "Greek root micro and scale vocabulary", "Today I am learning to use micro to investigate words connected with small size or scale.", ["I can identify micro in a familiar word.", "I can connect micro with a word's meaning using context."], "Sort and analyse micro words, then explain how the root contributes to each word.", "Ask the learner to explain a micro word using root and context evidence.", "Compare roots that describe size or scale.", "The learner is beginning to use micro and context to interpret related vocabulary."),
  createWordBuilderStep(17, "r-u009-root-macro", "Greek Root macro", "Recognise macro as a meaning-bearing root connected with large or great and use it to analyse related vocabulary.", "Greek root macro and scale vocabulary", "Today I am learning to use macro to investigate words connected with large scale.", ["I can identify macro in a familiar word.", "I can connect macro with a word's meaning."], "Sort and analyse macro words, then explain how the root contributes to each word.", "Ask the learner to explain how macro contributes to the meaning of familiar words.", "Compare macro with roots that describe size or scale.", "The learner is beginning to use the root macro and context to interpret scale-related vocabulary."),
  createWordBuilderStep(18, "r-u010-root-photo-phot", "Greek Roots photo / phot", "Recognise photo and phot as related roots connected with light and use them to analyse related vocabulary.", "Greek roots photo and phot in word analysis", "Today I am learning to use photo and phot to investigate words connected with light.", ["I can identify photo or phot in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse photo and phot words, then explain how the root contributes to each word.", "Ask the learner to explain a photo or phot word using root and context evidence.", "Use root knowledge to investigate science and technology vocabulary.", "The learner is beginning to use photo and phot as clues when analysing related vocabulary."),
  createWordBuilderStep(19, "r-u011-root-therm", "Greek Root therm", "Recognise therm as a meaning-bearing root connected with heat and use it to analyse related vocabulary.", "Greek root therm and science vocabulary", "Today I am learning to use therm to investigate words connected with heat.", ["I can identify therm in a familiar word.", "I can connect therm with a word's meaning."], "Sort and analyse therm words, then relate the root meaning to familiar science vocabulary.", "Ask the learner to explain how therm contributes to the meaning of familiar words.", "Compare other roots used in science and measurement vocabulary.", "The learner is beginning to use the root therm and context to interpret heat-related vocabulary."),
  createWordBuilderStep(66, "r-u012-root-hydro", "Greek Root hydro", "Recognise hydro as a meaning-bearing root connected with water and use it to analyse related vocabulary.", "Greek root hydro and science vocabulary", "Today I am learning to use hydro to investigate words connected with water.", ["I can identify hydro in a familiar word.", "I can connect hydro with a word's meaning using context."], "Sort and analyse hydro words, then explain how the root contributes to each word.", "Ask the learner to explain a hydro word using root and context evidence.", "Use roots to infer meaning in science and environmental vocabulary.", "The learner is beginning to use hydro and context to interpret water-related vocabulary."),
  createWordBuilderStep(20, "r-u013-root-astro-astr", "Greek Roots astro / astr", "Recognise astro and astr as related roots connected with stars or space and use them to analyse vocabulary.", "Greek roots astro and astr in word analysis", "Today I am learning to use astro and astr to investigate words connected with stars or space.", ["I can identify astro or astr in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse astro and astr words, then explain how the root contributes to each word.", "Ask the learner to explain an astro or astr word using root and context evidence.", "Use roots to infer meaning in science and astronomy vocabulary.", "The learner is beginning to use astro and astr as clues when analysing related vocabulary."),
  createWordBuilderStep(21, "r-u014-root-metr-meter", "Greek Roots metr / meter", "Recognise metr and meter as related roots connected with measurement and use them to analyse vocabulary.", "Greek roots metr and meter in measurement vocabulary", "Today I am learning to use metr and meter to investigate words connected with measurement.", ["I can identify metr or meter in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse metr and meter words, then explain how the root contributes to each word.", "Ask the learner to explain a metr or meter word using root and context evidence.", "Use root knowledge to interpret measurement vocabulary across subjects.", "The learner is beginning to use metr and meter as clues when analysing related vocabulary."),
  createWordBuilderStep(22, "r-u016-root-auto", "Greek Root auto", "Recognise auto as a meaning-bearing root connected with self and use it to analyse related vocabulary.", "Greek root auto and word analysis", "Today I am learning to use auto to investigate words connected with self.", ["I can identify auto in a familiar word.", "I can use auto and context to discuss a word's meaning."], "Sort and analyse auto words, then connect the root meaning with each whole word.", "Ask the learner to explain how auto contributes to the meaning of familiar words.", "Compare roots that express self, other, or relationship.", "The learner is beginning to use the root auto and context to interpret related vocabulary."),
  createWordBuilderStep(23, "r-u017-root-demo-dem", "Greek Roots demo / dem", "Recognise demo and dem as related roots connected with people or a population and use them to analyse vocabulary.", "Greek roots demo and dem in word analysis", "Today I am learning to use demo and dem to investigate words connected with people or populations.", ["I can identify demo or dem in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse demo and dem words, then explain how the root contributes to each word.", "Ask the learner to explain a demo or dem word using root and context evidence.", "Use roots to infer meaning in civics and social-science vocabulary.", "The learner is beginning to use demo and dem as clues when analysing related vocabulary."),
  createWordBuilderStep(24, "r-u018-root-psych", "Greek Root psych", "Recognise psych as a meaning-bearing root connected with mind and use it to analyse related vocabulary.", "Greek root psych and academic word analysis", "Today I am learning to use psych to investigate words connected with the mind.", ["I can identify psych in a familiar word.", "I can use psych and context to discuss a word's meaning."], "Sort and analyse psych words, then connect the root meaning with each whole word.", "Ask the learner to explain how psych contributes to the meaning of familiar words.", "Use roots to infer meaning in psychology and social-science vocabulary.", "The learner is beginning to use the root psych and context to interpret related vocabulary."),
  createWordBuilderStep(25, "r-u019-root-log-logy", "Greek Roots log / logy", "Recognise log and logy as related roots connected with words, study, or knowledge where supported by the word family.", "Greek roots log and logy in word analysis", "Today I am learning to use log and logy to investigate words connected with study or knowledge.", ["I can identify log or logy in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse log and logy words, then explain how the root contributes to each word.", "Ask the learner to explain a log or logy word using root and context evidence.", "Use roots to infer meaning in academic subject vocabulary.", "The learner is beginning to use log and logy as clues when analysing related vocabulary."),
  createWordBuilderStep(26, "r-u020-root-path", "Greek Root path", "Recognise path as a meaning-bearing root connected with feeling or experience and use it to analyse related vocabulary where supported by the word family.", "Greek root path and word analysis", "Today I am learning to use path to investigate words connected with feeling or experience.", ["I can identify path in a familiar word.", "I can use path and context to discuss a word's meaning."], "Sort and analyse path words, then connect the root meaning with each whole word.", "Ask the learner to explain how path contributes to the meaning of familiar words.", "Use roots to infer meaning in health and academic vocabulary.", "The learner is beginning to use the root path and context to interpret related vocabulary."),
];

const ROOTS_E2_WORD_BUILDER_STEPS: EnglishStepInput[] = [
  createWordBuilderStep(27, "r-u021-root-gen", "Greek Root gen", "Recognise gen as a meaning-bearing root connected with birth, origin, or kind where supported by the word family.", "Greek root gen and word analysis", "Today I am learning to use gen to investigate words connected with birth, origin, or kind.", ["I can identify gen in a familiar word.", "I can use root and context evidence to discuss a word's meaning."], "Sort and analyse gen words, then connect the root meaning with each whole word.", "Ask the learner to explain how gen contributes to the meaning of familiar words.", "Use roots to infer meaning in science and academic vocabulary.", "The learner is beginning to use gen and context to interpret related vocabulary."),
  createWordBuilderStep(28, "r-u022-root-cycl", "Greek Root cycl", "Recognise cycl as a meaning-bearing root connected with circles or wheels and use it to analyse related vocabulary.", "Greek root cycl and word analysis", "Today I am learning to use cycl to investigate words connected with circles or wheels.", ["I can identify cycl in a familiar word.", "I can connect cycl with a word's meaning using context."], "Sort and analyse cycl words, then explain how the root contributes to each word.", "Ask the learner to explain a cycl word using root and context evidence.", "Compare roots used in shape, movement, and science vocabulary.", "The learner is beginning to use cycl and context to interpret related vocabulary."),
  createWordBuilderStep(29, "r-u023-root-poly", "Greek Root poly", "Recognise poly as a meaning-bearing root connected with many and use it to analyse related vocabulary.", "Greek root poly and word analysis", "Today I am learning to use poly to investigate words connected with many or much.", ["I can identify poly in a familiar word.", "I can connect poly with a word's meaning using context."], "Sort and analyse poly words, then explain how the root contributes to each word.", "Ask the learner to explain a poly word using root and context evidence.", "Use roots to infer meaning in mathematics, science, and academic vocabulary.", "The learner is beginning to use poly and context to interpret related vocabulary."),
  createWordBuilderStep(30, "r-u024-root-mono", "Greek Root mono", "Recognise mono as a meaning-bearing root connected with one or single and use it to analyse related vocabulary.", "Greek root mono and word analysis", "Today I am learning to use mono to investigate words connected with one or single.", ["I can identify mono in a familiar word.", "I can connect mono with a word's meaning using context."], "Sort and analyse mono words, then explain how the root contributes to each word.", "Ask the learner to explain a mono word using root and context evidence.", "Compare roots that express number, amount, or scale.", "The learner is beginning to use mono and context to interpret related vocabulary."),
  createWordBuilderStep(31, "r-u025-root-techn-techno", "Greek Roots techn / techno", "Recognise techn and techno as related roots connected with skill, art, or craft and use them to analyse vocabulary.", "Greek roots techn and techno in word analysis", "Today I am learning to use techn and techno to investigate words connected with skill, art, or craft.", ["I can identify techn or techno in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse techn and techno words, then explain how the root contributes to each word.", "Ask the learner to explain a techn or techno word using root and context evidence.", "Use roots to infer meaning in technology and subject vocabulary.", "The learner is beginning to use techn and techno as clues when analysing related vocabulary."),
  createWordBuilderStep(32, "r-u026-root-port", "Latin Root port", "Recognise port as a meaning-bearing root connected with carrying and use it to analyse related vocabulary.", "Latin root port and word analysis", "Today I am learning to use port to investigate words connected with carrying.", ["I can identify port in a familiar word.", "I can connect port with a word's meaning using context."], "Sort and analyse port words, then explain how the root contributes to each word.", "Ask the learner to explain a port word using root and context evidence.", "Compare roots used in movement, transport, and communication vocabulary.", "The learner is beginning to use port and context to interpret related vocabulary."),
  createWordBuilderStep(33, "r-u027-root-struct", "Latin Root struct", "Recognise struct as a meaning-bearing root connected with building or putting together and use it to analyse vocabulary.", "Latin root struct and word analysis", "Today I am learning to use struct to investigate words connected with building.", ["I can identify struct in a familiar word.", "I can connect struct with a word's meaning using context."], "Sort and analyse struct words, then explain how the root contributes to each word.", "Ask the learner to explain a struct word using root and context evidence.", "Use roots to infer meaning in construction and academic vocabulary.", "The learner is beginning to use struct and context to interpret related vocabulary."),
  createWordBuilderStep(34, "r-u028-root-spect", "Latin Root spect", "Recognise spect as a meaning-bearing root connected with looking or seeing and use it to analyse vocabulary.", "Latin root spect and word analysis", "Today I am learning to use spect to investigate words connected with looking or seeing.", ["I can identify spect in a familiar word.", "I can connect spect with a word's meaning using context."], "Sort and analyse spect words, then explain how the root contributes to each word.", "Ask the learner to explain a spect word using root and context evidence.", "Use roots to infer meaning in observation and academic vocabulary.", "The learner is beginning to use spect and context to interpret related vocabulary."),
  createWordBuilderStep(35, "r-u029-root-scrib-script", "Latin Roots scrib / script", "Recognise scrib and script as related roots connected with writing and use them to analyse vocabulary.", "Latin roots scrib and script in word analysis", "Today I am learning to use scrib and script to investigate words connected with writing.", ["I can identify scrib or script in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse scrib and script words, then explain how the root contributes to each word.", "Ask the learner to explain a scrib or script word using root and context evidence.", "Use roots to infer meaning in communication and academic vocabulary.", "The learner is beginning to use scrib and script as clues when analysing related vocabulary."),
  createWordBuilderStep(36, "r-u030-root-tract", "Latin Root tract", "Recognise tract as a meaning-bearing root connected with pulling or drawing and use it to analyse vocabulary.", "Latin root tract and word analysis", "Today I am learning to use tract to investigate words connected with pulling or drawing.", ["I can identify tract in a familiar word.", "I can connect tract with a word's meaning using context."], "Sort and analyse tract words, then explain how the root contributes to each word.", "Ask the learner to explain a tract word using root and context evidence.", "Compare roots used in movement, force, and academic vocabulary.", "The learner is beginning to use tract and context to interpret related vocabulary."),
  createWordBuilderStep(37, "r-u031-root-ject", "Latin Root ject", "Recognise ject as a meaning-bearing root connected with throwing or sending and use it to analyse vocabulary.", "Latin root ject and word analysis", "Today I am learning to use ject to investigate words connected with throwing or sending.", ["I can identify ject in a familiar word.", "I can connect ject with a word's meaning using context."], "Sort and analyse ject words, then explain how the root contributes to each word.", "Ask the learner to explain a ject word using root and context evidence.", "Use roots to infer meaning in movement and communication vocabulary.", "The learner is beginning to use ject and context to interpret related vocabulary."),
  createWordBuilderStep(38, "r-u032-root-dict", "Latin Root dict", "Recognise dict as a meaning-bearing root connected with saying or speaking and use it to analyse vocabulary.", "Latin root dict and word analysis", "Today I am learning to use dict to investigate words connected with saying or speaking.", ["I can identify dict in a familiar word.", "I can connect dict with a word's meaning using context."], "Sort and analyse dict words, then explain how the root contributes to each word.", "Ask the learner to explain a dict word using root and context evidence.", "Use roots to infer meaning in communication and academic vocabulary.", "The learner is beginning to use dict and context to interpret related vocabulary."),
  createWordBuilderStep(39, "r-u033-root-rupt", "Latin Root rupt", "Recognise rupt as a meaning-bearing root connected with breaking and use it to analyse related vocabulary.", "Latin root rupt and word analysis", "Today I am learning to use rupt to investigate words connected with breaking.", ["I can identify rupt in a familiar word.", "I can connect rupt with a word's meaning using context."], "Sort and analyse rupt words, then explain how the root contributes to each word.", "Ask the learner to explain a rupt word using root and context evidence.", "Compare roots used in change, movement, and processes.", "The learner is beginning to use rupt and context to interpret related vocabulary."),
  createWordBuilderStep(40, "r-u034-root-mit-miss", "Latin Roots mit / miss", "Recognise mit and miss as related roots connected with sending and use them to analyse vocabulary.", "Latin roots mit and miss in word analysis", "Today I am learning to use mit and miss to investigate words connected with sending.", ["I can identify mit or miss in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse mit and miss words, then explain how the root contributes to each word.", "Ask the learner to explain a mit or miss word using root and context evidence.", "Use roots to infer meaning in communication and movement vocabulary.", "The learner is beginning to use mit and miss as clues when analysing related vocabulary."),
  createWordBuilderStep(41, "r-u035-root-duc-duct", "Latin Roots duc / duct", "Recognise duc and duct as related roots connected with leading and use them to analyse vocabulary.", "Latin roots duc and duct in word analysis", "Today I am learning to use duc and duct to investigate words connected with leading.", ["I can identify duc or duct in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse duc and duct words, then explain how the root contributes to each word.", "Ask the learner to explain a duc or duct word using root and context evidence.", "Use roots to infer meaning in movement, leadership, and academic vocabulary.", "The learner is beginning to use duc and duct as clues when analysing related vocabulary."),
  createWordBuilderStep(42, "r-u036-root-fer", "Latin Root fer", "Recognise fer as a meaning-bearing root connected with carrying or bearing and use it to analyse vocabulary.", "Latin root fer and word analysis", "Today I am learning to use fer to investigate words connected with carrying or bearing.", ["I can identify fer in a familiar word.", "I can connect fer with a word's meaning using context."], "Sort and analyse fer words, then explain how the root contributes to each word.", "Ask the learner to explain a fer word using root and context evidence.", "Compare roots used in carrying, movement, and responsibility vocabulary.", "The learner is beginning to use fer and context to interpret related vocabulary."),
  createWordBuilderStep(67, "r-u037-root-pend-pens", "Latin Roots pend / pens", "Recognise pend and pens as related roots and use the worksheet-supported meaning to analyse related vocabulary.", "Latin roots pend and pens in word analysis", "Today I am learning to use pend and pens to investigate related vocabulary.", ["I can identify pend or pens in a familiar word.", "I can use the worksheet meaning and context to discuss a word."], "Sort and analyse pend and pens words, then explain how the root contributes to each word.", "Ask the learner to explain a pend or pens word using root and context evidence.", "Use further roots to infer meaning in academic vocabulary.", "The learner is beginning to use pend and pens as clues when analysing related vocabulary."),
  createWordBuilderStep(43, "r-u038-root-cred", "Latin Root cred", "Recognise cred as a meaning-bearing root connected with believing or trusting and use it to analyse vocabulary.", "Latin root cred and word analysis", "Today I am learning to use cred to investigate words connected with believing or trusting.", ["I can identify cred in a familiar word.", "I can connect cred with a word's meaning using context."], "Sort and analyse cred words, then explain how the root contributes to each word.", "Ask the learner to explain a cred word using root and context evidence.", "Use roots to infer meaning in belief, evidence, and academic vocabulary.", "The learner is beginning to use cred and context to interpret related vocabulary."),
  createWordBuilderStep(44, "r-u039-root-vid-vis", "Latin Roots vid / vis", "Recognise vid and vis as related roots connected with seeing and use them to analyse vocabulary.", "Latin roots vid and vis in word analysis", "Today I am learning to use vid and vis to investigate words connected with seeing.", ["I can identify vid or vis in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse vid and vis words, then explain how the root contributes to each word.", "Ask the learner to explain a vid or vis word using root and context evidence.", "Use roots to infer meaning in observation, evidence, and academic vocabulary.", "The learner is beginning to use vid and vis as clues when analysing related vocabulary."),
  createWordBuilderStep(45, "r-u040-root-voc-vok", "Latin Roots voc / vok", "Recognise voc and vok as related roots connected with calling or voice and use them to analyse vocabulary.", "Latin roots voc and vok in word analysis", "Today I am learning to use voc and vok to investigate words connected with calling or voice.", ["I can identify voc or vok in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse voc and vok words, then explain how the root contributes to each word.", "Ask the learner to explain a voc or vok word using root and context evidence.", "Use roots to infer meaning in communication and academic vocabulary.", "The learner is beginning to use voc and vok as clues when analysing related vocabulary."),
];

const ROOTS_E3_WORD_BUILDER_STEPS: EnglishStepInput[] = [
  createWordBuilderStep(46, "r-u041-root-aud", "Latin Root aud", "Recognise aud as a meaning-bearing root connected with hearing and use it to analyse related vocabulary.", "Latin root aud and word analysis", "Today I am learning to use aud to investigate words connected with hearing.", ["I can identify aud in a familiar word.", "I can connect aud with a word's meaning using context."], "Sort and analyse aud words, then explain how the root contributes to each word.", "Ask the learner to explain an aud word using root and context evidence.", "Use roots to infer meaning in communication and academic vocabulary.", "The learner is beginning to use aud and context to interpret related vocabulary."),
  createWordBuilderStep(47, "r-u042-root-cap-cept-cip", "Latin Roots cap / cept / cip", "Recognise cap, cept, and cip as related roots connected with taking or receiving and use them to analyse vocabulary.", "Latin roots cap, cept, and cip in word analysis", "Today I am learning to use cap, cept, and cip to investigate words connected with taking or receiving.", ["I can identify cap, cept, or cip in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse cap, cept, and cip words, then explain how the root contributes to each word.", "Ask the learner to explain a cap, cept, or cip word using root and context evidence.", "Use roots to infer meaning in academic and subject vocabulary.", "The learner is beginning to use cap, cept, and cip as clues when analysing related vocabulary."),
  createWordBuilderStep(48, "r-u043-root-fac-fect-fic", "Latin Roots fac / fect / fic", "Recognise fac, fect, and fic as related roots connected with making or doing and use them to analyse vocabulary.", "Latin roots fac, fect, and fic in word analysis", "Today I am learning to use fac, fect, and fic to investigate words connected with making or doing.", ["I can identify fac, fect, or fic in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse fac, fect, and fic words, then explain how the root contributes to each word.", "Ask the learner to explain a fac, fect, or fic word using root and context evidence.", "Use roots to infer meaning in action, process, and academic vocabulary.", "The learner is beginning to use fac, fect, and fic as clues when analysing related vocabulary."),
  createWordBuilderStep(49, "r-u044-root-grad-gress", "Latin Roots grad / gress", "Recognise grad and gress as related roots connected with stepping or going and use them to analyse vocabulary.", "Latin roots grad and gress in word analysis", "Today I am learning to use grad and gress to investigate words connected with stepping or going.", ["I can identify grad or gress in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse grad and gress words, then explain how the root contributes to each word.", "Ask the learner to explain a grad or gress word using root and context evidence.", "Use roots to infer meaning in movement and progression vocabulary.", "The learner is beginning to use grad and gress as clues when analysing related vocabulary."),
  createWordBuilderStep(50, "r-u045-root-pos-pon", "Latin Roots pos / pon", "Recognise pos and pon as related roots connected with putting or placing and use them to analyse vocabulary.", "Latin roots pos and pon in word analysis", "Today I am learning to use pos and pon to investigate words connected with putting or placing.", ["I can identify pos or pon in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse pos and pon words, then explain how the root contributes to each word.", "Ask the learner to explain a pos or pon word using root and context evidence.", "Use roots to infer meaning in position, arrangement, and academic vocabulary.", "The learner is beginning to use pos and pon as clues when analysing related vocabulary."),
  createWordBuilderStep(51, "r-u046-root-ten-tain", "Latin Roots ten / tain", "Recognise ten and tain as related roots connected with holding and use them to analyse vocabulary.", "Latin roots ten and tain in word analysis", "Today I am learning to use ten and tain to investigate words connected with holding.", ["I can identify ten or tain in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse ten and tain words, then explain how the root contributes to each word.", "Ask the learner to explain a ten or tain word using root and context evidence.", "Use roots to infer meaning in control, support, and academic vocabulary.", "The learner is beginning to use ten and tain as clues when analysing related vocabulary."),
  createWordBuilderStep(52, "r-u047-root-ven-vent", "Latin Roots ven / vent", "Recognise ven and vent as related roots connected with coming and use them to analyse vocabulary.", "Latin roots ven and vent in word analysis", "Today I am learning to use ven and vent to investigate words connected with coming.", ["I can identify ven or vent in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse ven and vent words, then explain how the root contributes to each word.", "Ask the learner to explain a ven or vent word using root and context evidence.", "Use roots to infer meaning in movement, arrival, and academic vocabulary.", "The learner is beginning to use ven and vent as clues when analysing related vocabulary."),
  createWordBuilderStep(53, "r-u048-root-ced-ceed-cess", "Latin Roots ced / ceed / cess", "Recognise ced, ceed, and cess as related roots connected with going, yielding, or moving and use them to analyse vocabulary.", "Latin roots ced, ceed, and cess in word analysis", "Today I am learning to use ced, ceed, and cess to investigate words connected with going or yielding.", ["I can identify ced, ceed, or cess in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse ced, ceed, and cess words, then explain how the root contributes to each word.", "Ask the learner to explain a ced, ceed, or cess word using root and context evidence.", "Use roots to infer meaning in movement, change, and academic vocabulary.", "The learner is beginning to use ced, ceed, and cess as clues when analysing related vocabulary."),
  createWordBuilderStep(54, "r-u049-root-form", "Latin Root form", "Recognise form as a meaning-bearing root connected with shape or form and use it to analyse related vocabulary.", "Latin root form and word analysis", "Today I am learning to use form to investigate words connected with shape or form.", ["I can identify form in a familiar word.", "I can connect form with a word's meaning using context."], "Sort and analyse form words, then explain how the root contributes to each word.", "Ask the learner to explain a form word using root and context evidence.", "Use roots to infer meaning in shape, structure, and academic vocabulary.", "The learner is beginning to use form and context to interpret related vocabulary."),
  createWordBuilderStep(55, "r-u050-root-terr", "Latin Root terr", "Recognise terr as a meaning-bearing root connected with earth or land and use it to analyse related vocabulary.", "Latin root terr and word analysis", "Today I am learning to use terr to investigate words connected with earth or land.", ["I can identify terr in a familiar word.", "I can connect terr with a word's meaning using context."], "Sort and analyse terr words, then explain how the root contributes to each word.", "Ask the learner to explain a terr word using root and context evidence.", "Use roots to infer meaning in geography and environmental vocabulary.", "The learner is beginning to use terr and context to interpret related vocabulary."),
  createWordBuilderStep(56, "r-u051-root-aqu-aqua", "Latin Roots aqu / aqua", "Recognise aqu and aqua as related roots connected with water and use them to analyse vocabulary.", "Latin roots aqu and aqua in word analysis", "Today I am learning to use aqu and aqua to investigate words connected with water.", ["I can identify aqu or aqua in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse aqu and aqua words, then explain how the root contributes to each word.", "Ask the learner to explain an aqu or aqua word using root and context evidence.", "Use roots to infer meaning in science and environmental vocabulary.", "The learner is beginning to use aqu and aqua as clues when analysing related vocabulary."),
  createWordBuilderStep(57, "r-u052-root-ped", "Latin Root ped", "Recognise ped as a meaning-bearing root connected with the foot and use it to analyse related vocabulary.", "Latin root ped and word analysis", "Today I am learning to use ped to investigate words connected with the foot.", ["I can identify ped in a familiar word.", "I can connect ped with a word's meaning using context."], "Sort and analyse ped words, then explain how the root contributes to each word.", "Ask the learner to explain a ped word using root and context evidence.", "Use roots to infer meaning in movement, measurement, and academic vocabulary.", "The learner is beginning to use ped and context to interpret related vocabulary."),
  createWordBuilderStep(58, "r-u053-root-man-manu", "Latin Roots man / manu", "Recognise man and manu as related roots connected with the hand and use them to analyse vocabulary.", "Latin roots man and manu in word analysis", "Today I am learning to use man and manu to investigate words connected with the hand.", ["I can identify man or manu in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse man and manu words, then explain how the root contributes to each word.", "Ask the learner to explain a man or manu word using root and context evidence.", "Use roots to infer meaning in making, handling, and academic vocabulary.", "The learner is beginning to use man and manu as clues when analysing related vocabulary."),
  createWordBuilderStep(59, "r-u054-root-mar", "Latin Root mar", "Recognise mar as a meaning-bearing root connected with the sea and use it to analyse related vocabulary.", "Latin root mar and word analysis", "Today I am learning to use mar to investigate words connected with the sea.", ["I can identify mar in a familiar word.", "I can connect mar with a word's meaning using context."], "Sort and analyse mar words, then explain how the root contributes to each word.", "Ask the learner to explain a mar word using root and context evidence.", "Use roots to infer meaning in geography and environmental vocabulary.", "The learner is beginning to use mar and context to interpret related vocabulary."),
  createWordBuilderStep(60, "r-u055-root-loc", "Latin Root loc", "Recognise loc as a meaning-bearing root connected with place and use it to analyse related vocabulary.", "Latin root loc and word analysis", "Today I am learning to use loc to investigate words connected with place.", ["I can identify loc in a familiar word.", "I can connect loc with a word's meaning using context."], "Sort and analyse loc words, then explain how the root contributes to each word.", "Ask the learner to explain a loc word using root and context evidence.", "Use roots to infer meaning in geography and academic vocabulary.", "The learner is beginning to use loc and context to interpret related vocabulary."),
  createWordBuilderStep(61, "r-u056-root-mov-mot", "Latin Roots mov / mot", "Recognise mov and mot as related roots connected with movement and use them to analyse vocabulary.", "Latin roots mov and mot in word analysis", "Today I am learning to use mov and mot to investigate words connected with movement.", ["I can identify mov or mot in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse mov and mot words, then explain how the root contributes to each word.", "Ask the learner to explain a mov or mot word using root and context evidence.", "Use roots to infer meaning in movement, change, and academic vocabulary.", "The learner is beginning to use mov and mot as clues when analysing related vocabulary."),
  createWordBuilderStep(62, "r-u057-root-nov", "Latin Root nov", "Recognise nov as a meaning-bearing root connected with newness and use it to analyse related vocabulary.", "Latin root nov and word analysis", "Today I am learning to use nov to investigate words connected with newness.", ["I can identify nov in a familiar word.", "I can connect nov with a word's meaning using context."], "Sort and analyse nov words, then explain how the root contributes to each word.", "Ask the learner to explain a nov word using root and context evidence.", "Use roots to infer meaning in change and academic vocabulary.", "The learner is beginning to use nov and context to interpret related vocabulary."),
  createWordBuilderStep(68, "r-u058-root-mont", "Latin Root mont", "Recognise mont as a meaning-bearing root connected with a mountain and use it to analyse related vocabulary.", "Latin root mont and geography vocabulary", "Today I am learning to use mont to investigate words connected with mountains.", ["I can identify mont in a familiar word.", "I can connect mont with a word's meaning using context."], "Sort and analyse mont words, then explain how the root contributes to each word.", "Ask the learner to explain a mont word using root and context evidence.", "Use roots to infer meaning in geography and environmental vocabulary.", "The learner is beginning to use mont and context to interpret related vocabulary."),
  createWordBuilderStep(63, "r-u059-root-anim-anima", "Latin Roots anim / anima", "Recognise anim and anima as related roots connected with life or spirit and use them to analyse vocabulary.", "Latin roots anim and anima in word analysis", "Today I am learning to use anim and anima to investigate words connected with life or spirit.", ["I can identify anim or anima in a familiar word.", "I can connect the root with the word's meaning using context."], "Sort and analyse anim and anima words, then explain how the root contributes to each word.", "Ask the learner to explain an anim or anima word using root and context evidence.", "Use roots to infer meaning in life, behaviour, and academic vocabulary.", "The learner is beginning to use anim and anima as clues when analysing related vocabulary."),
  createWordBuilderStep(64, "r-u060-root-bene", "Latin Root bene", "Recognise bene as a meaning-bearing root connected with good or well and use it to analyse related vocabulary.", "Latin root bene and word analysis", "Today I am learning to use bene to investigate words connected with good or well.", ["I can identify bene in a familiar word.", "I can connect bene with a word's meaning using context."], "Sort and analyse bene words, then explain how the root contributes to each word.", "Ask the learner to explain a bene word using root and context evidence.", "Use roots to infer meaning in values, quality, and academic vocabulary.", "The learner is beginning to use bene and context to interpret related vocabulary."),
];

MORPHOLOGY_AND_SPELLING.stages[0].steps.push(...ADDITIONAL_MORPHOLOGY_WORD_BUILDER_STEPS);
MORPHOLOGY_AND_SPELLING.stages.push(
  {
    key: "upper-primary",
    helper: "Upper-primary morphology extends transparent affix knowledge into richer suffix families, assimilated prefixes, and more demanding word-family analysis.",
    steps: ADDITIONAL_MS_WORD_BUILDER_STEPS,
  },
  {
    key: "lower-secondary",
    helper: "Lower-secondary morphology uses advanced affixes, multiple morphemes, and academic vocabulary to support independent word analysis.",
    steps: [...ADDITIONAL_HSF_WORD_BUILDER_STEPS, ...ROOTS_E1_WORD_BUILDER_STEPS, ...ROOTS_E2_WORD_BUILDER_STEPS, ...ROOTS_E3_WORD_BUILDER_STEPS],
  },
);
