...
-- Use the verified primary-key constraint so PL/pgSQL cannot resolve the
-- conflict target as output variables instead of table columns.
...
begin
  ...
  on conflict on constraint family_evidence_storage_usage_pkey do nothing;
